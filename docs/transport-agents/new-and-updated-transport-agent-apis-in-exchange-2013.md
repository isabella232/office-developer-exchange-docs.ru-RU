---
title: Новые и обновленные API транспортных агентов в Exchange 2013 г.
manager: sethgros
ms.date: 09/17/2015
...
description: Узнайте, какие API являются новыми или обновляются в Exchange 2013 г. для транспортных агентов.
ms.openlocfilehash: 34334b39219ee6c25fda214f0905ab24309ae83f
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59542556"
---
# <a name="new-and-updated-transport-agent-apis-in-exchange-2013"></a>Новые и обновленные API транспортных агентов в Exchange 2013 г.

Узнайте, какие API являются новыми или обновляются в Exchange 2013 г. для транспортных агентов.

**Применяется к:** Exchange Server 2013 г. 
  
В этой статье перечислены типы, новые или обновленные в Exchange Server 2013 г., влияющие на транспортные агенты. Чтобы узнать об изменениях архитектуры в Exchange 2013 г., затрагивающих транспортных агентов, см. в Exchange [2013 г.](transport-agent-concepts-in-exchange-2013.md).
  
## <a name="new-types-for-transport-agent-development-in-exchange-2013"></a>Новые типы разработки транспортных агентов в Exchange 2013 г.

В 2013 г. Exchange новые типы:
...
## <a name="updated-types-for-transport-agent-development-in-exchange-2013"></a>Обновленные типы для разработки транспортных агентов в Exchange 2013 г.

В 2013 г. были обновлены следующие Exchange:
