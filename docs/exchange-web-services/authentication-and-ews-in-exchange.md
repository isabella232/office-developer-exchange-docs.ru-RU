...
- [пробная версия Office 365](http://office.microsoft.com/compare-office-365-for-business-plans-FX102918419.aspx?CR_CC=200061904&amp;WT.srch=1&amp;WT.mc_ID=PS_bing_O365Comm_office%20365%20trial_Text), позволяющая настроить сервер Exchange Server для тестирования клиентского приложения;
    
- [библиотека проверки подлинности Azure AD для .NET](http://msdn.microsoft.com/library/a03f39fa-7ba4-4182-a98e-55562a64b8f3%28Office.15%29.aspx);
...
- Просмотрите образец кода в [проверять подлинность приложения веб-служб Exchange с помощью OAuth](how-to-authenticate-an-ews-application-by-using-oauth.md) для примера кода, который можно изучить. 
