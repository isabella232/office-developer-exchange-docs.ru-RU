...
|**Имя параметра политики регулирования**|**Область применения**|**Описание**|
|:-----|:-----|:-----|
...
Сведения о олицетворение и параметр **EWSMaxSubscriptions** содержатся в разделе [регулирование для приложений, применяющих олицетворение EWS](#bk_ThrottlingConsiderations) ранее в этой статье. 
