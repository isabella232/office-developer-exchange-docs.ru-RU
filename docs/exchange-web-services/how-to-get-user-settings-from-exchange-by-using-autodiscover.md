...
- [<span data-ttu-id="e5e24-157">Веб-служб Exchange (EWS) управляемого интерфейса API</span><span class="sxs-lookup"><span data-stu-id="e5e24-157">Exchange Web Services (EWS) Managed API</span></span>](http://msdn.microsoft.com/ru-ru/library/exchange/jj220535%28v=exchg.80%29.aspx)
