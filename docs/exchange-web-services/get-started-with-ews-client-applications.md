...
- [Создайте Сайт разработчика в Office 365](http://msdn.microsoft.com/en-us/library/office/fp179924.aspx) (рекомендуется). Так можно получить почтовый ящик Exchange быстрее всего.
