...
|:-----|:-----|:-----|
|<span data-ttu-id="31da9-127">Повторяющегося элемента главного календаря</span><span class="sxs-lookup"><span data-stu-id="31da9-127">The recurring master calendar item</span></span>  <br/> | <span data-ttu-id="31da9-128">Первое в последовательности</span><span class="sxs-lookup"><span data-stu-id="31da9-128">The first occurrence in a series</span></span>  <br/>  <span data-ttu-id="31da9-129">Последнее вхождение из серии</span><span class="sxs-lookup"><span data-stu-id="31da9-129">The last occurrence in a series</span></span>  <br/>  <span data-ttu-id="31da9-130">Исключения в набор</span><span class="sxs-lookup"><span data-stu-id="31da9-130">The exceptions to a series</span></span>  <br/>  <span data-ttu-id="31da9-131">Удаленные встречи в цикле</span><span class="sxs-lookup"><span data-stu-id="31da9-131">The deleted appointments in a series</span></span>  <br/>  <span data-ttu-id="31da9-132">Все вхождения (при наличии индекса)</span><span class="sxs-lookup"><span data-stu-id="31da9-132">Any occurrence (given its index)</span></span>  <br/> |<span data-ttu-id="31da9-133">Свойство [Appointment.FirstOccurrence](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.appointment.firstoccurrence%28v=exchg.80%29.aspx)</span><span class="sxs-lookup"><span data-stu-id="31da9-133">[Appointment.FirstOccurrence](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.appointment.firstoccurrence%28v=exchg.80%29.aspx) property</span></span>  <br/> <span data-ttu-id="31da9-134">Свойство [Appointment.LastOccurrence](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.appointment.lastoccurrence%28v=exchg.80%29.aspx)</span><span class="sxs-lookup"><span data-stu-id="31da9-134">[Appointment.LastOccurrence](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.appointment.lastoccurrence%28v=exchg.80%29.aspx) property</span></span>  <br/> <span data-ttu-id="31da9-135">Свойство [Appointment.ModifiedOccurrences](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.appointment.modifiedoccurrences%28v=exchg.80%29.aspx)</span><span class="sxs-lookup"><span data-stu-id="31da9-135">[Appointment.ModifiedOccurrences](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.appointment.modifiedoccurrences%28v=exchg.80%29.aspx) property</span></span>  <br/> <span data-ttu-id="31da9-136">Свойство [Appointment.DeletedOccurrences](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.appointment.deletedoccurrences%28v=exchg.80%29.aspx)</span><span class="sxs-lookup"><span data-stu-id="31da9-136">[Appointment.DeletedOccurrences](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.appointment.deletedoccurrences%28v=exchg.80%29.aspx) property</span></span>  <br/> <span data-ttu-id="31da9-137">Метод [Appointment.BindToOccurrence](http://msdn.microsoft.com/ru-ru/library/office/microsoft.exchange.webservices.data.appointment.bindtooccurrence%28v=exchg.80%29.aspx)</span><span class="sxs-lookup"><span data-stu-id="31da9-137">[Appointment.BindToOccurrence](http://msdn.microsoft.com/ru-ru/library/office/microsoft.exchange.webservices.data.appointment.bindtooccurrence%28v=exchg.80%29.aspx) method</span></span>  <br/> |
...
|<span data-ttu-id="31da9-141">Любой элемент календаря (объект [Appointment](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.appointment%28v=exchg.80%29.aspx) )</span><span class="sxs-lookup"><span data-stu-id="31da9-141">Any calendar item (an [Appointment](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.appointment%28v=exchg.80%29.aspx) object)</span></span>  <br/> |<span data-ttu-id="31da9-142">Значение перечисления для [типа встречи](http://msdn.microsoft.com/ru-ru/library/office/microsoft.exchange.webservices.data.appointmenttype%28v=exchg.80%29.aspx)</span><span class="sxs-lookup"><span data-stu-id="31da9-142">The [appointment type](http://msdn.microsoft.com/ru-ru/library/office/microsoft.exchange.webservices.data.appointmenttype%28v=exchg.80%29.aspx) enumeration value</span></span>  <br/> |<span data-ttu-id="31da9-143">Свойство [Appointment.AppointmentType](http://msdn.microsoft.com/ru-ru/library/office/microsoft.exchange.webservices.data.appointment.appointmenttype%28v=exchg.80%29.aspx)</span><span class="sxs-lookup"><span data-stu-id="31da9-143">[Appointment.AppointmentType](http://msdn.microsoft.com/ru-ru/library/office/microsoft.exchange.webservices.data.appointment.appointmenttype%28v=exchg.80%29.aspx) property</span></span>  <br/> |
...
<span data-ttu-id="31da9-145">В этом примере предполагается, что прошедшие проверку подлинности на сервере Exchange и приобрели объект [ExchangeService](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.exchangeservice%28v=exchg.80%29.aspx) с именем **службы**.</span><span class="sxs-lookup"><span data-stu-id="31da9-145">This example assumes that you have authenticated to an Exchange server and have acquired an [ExchangeService](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.exchangeservice%28v=exchg.80%29.aspx) object named **service**.</span></span> 
