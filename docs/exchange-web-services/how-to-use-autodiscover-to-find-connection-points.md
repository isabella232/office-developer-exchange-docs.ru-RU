...
> [!IMPORTANT]
> Критерии для проверки правильности ответа в режиме одобрения администратором в разделе [службы автообнаружения для Exchange](autodiscover-for-exchange.md). 
