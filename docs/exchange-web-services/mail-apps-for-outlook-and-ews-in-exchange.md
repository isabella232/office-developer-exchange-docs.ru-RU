...
---
# <a name="mail-apps-for-outlook-and-ews-in-exchange"></a>Приложения электронной почты для Outlook и EWS в Exchange

Найдите сведения о почтовых приложений для Outlook и работы с веб-служб Exchange в Exchange.
...
## <a name="ews-and-mail-apps-for-outlook"></a>Веб-служб Exchange и почтового приложения для Outlook
...
Необходимо также убедитесь в том, что ваше приложение запрашивает разрешение чтение и запись почтового ящика в приложениях для Office [модель разрешений](http://msdn.microsoft.com/library/5bca69f2-b287-4e19-8f0f-78d896b2a3d3%28Office.15%29.aspx).
...
Маркер обратного вызова службы — это непрозрачный маркера, который подключает службы сторонних производителей для запроса веб-служб Exchange в заголовок проверки подлинности носителя. Маркер определяет почтового приложения и почтовых ящиков для улучшения защиты запроса веб-служб Exchange. Чтобы узнать, как использовать службы маркеров обратного вызова, обратитесь к разделу [почтовые приложения для Outlook: получение вложений с сервера Exchange,](http://code.msdn.microsoft.com/exchange/Mail-apps-for-Office-Get-38babdc9) образца. 
...
- [Общие сведения о разрешениях для надстроек Outlook](http://msdn.microsoft.com/library/5bca69f2-b287-4e19-8f0f-78d896b2a3d3%28Office.15%29.aspx)
    
- [SET-WebServicesVirtualDirectory](http://technet.microsoft.com/en-us/library/aa997233%28v=exchg.150%29.aspx)
    
- [Почтовые приложения для Outlook: для выполнения запроса EWS](http://code.msdn.microsoft.com/office/Mail-apps-for-Outlook-Make-770b2528)
    
- [Почтовые приложения для Outlook: Использование маркера удостоверения клиента](http://code.msdn.microsoft.com/Mail-apps-for-Outlook-Use-b20a66b6)
    
- [Почтовые приложения для Outlook: получение вложений с сервера Exchange](http://code.msdn.microsoft.com/office/Mail-apps-for-Office-Get-38babdc9)
