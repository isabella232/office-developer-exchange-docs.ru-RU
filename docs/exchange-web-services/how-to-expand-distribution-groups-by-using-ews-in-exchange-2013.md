...
<span data-ttu-id="72faf-105">Можно использовать метод управляемый API EWS [ExchangeService.ExpandGroup](http://msdn.microsoft.com/ru-ru/library/office/microsoft.exchange.webservices.data.exchangeservice.expandgroup%28v=exchg.80%29.aspx) или операция [ExpandDL](http://msdn.microsoft.com/library/1f7837e7-9eff-4e10-9577-c40f7ed6af94%28Office.15%29.aspx) веб-служб Exchange разверните группу рассылки для идентификации всех получателей.</span><span class="sxs-lookup"><span data-stu-id="72faf-105">You can use the [ExchangeService.ExpandGroup](http://msdn.microsoft.com/ru-ru/library/office/microsoft.exchange.webservices.data.exchangeservice.expandgroup%28v=exchg.80%29.aspx) EWS Managed API method or the [ExpandDL](http://msdn.microsoft.com/library/1f7837e7-9eff-4e10-9577-c40f7ed6af94%28Office.15%29.aspx) EWS operation to expand a distribution group to identify all recipients.</span></span> 
  
<span data-ttu-id="72faf-106">Так как метод [ExpandGroup](http://msdn.microsoft.com/ru-ru/library/office/ee344007%28v=exchg.80%29.aspx) перегружен, его можно вызвать несколькими способами:</span><span class="sxs-lookup"><span data-stu-id="72faf-106">Because the [ExpandGroup](http://msdn.microsoft.com/ru-ru/library/office/ee344007%28v=exchg.80%29.aspx) method is overloaded, you can call it in several ways:</span></span> 
  
- <span data-ttu-id="72faf-107">[ExpandGroup(String)](http://msdn.microsoft.com/ru-ru/library/office/ee343988%28v=exchg.80%29.aspx) - расширяет группу, определенную SMTP-адрес.</span><span class="sxs-lookup"><span data-stu-id="72faf-107">[ExpandGroup(String)](http://msdn.microsoft.com/ru-ru/library/office/ee343988%28v=exchg.80%29.aspx) - Expands a group identified by an SMTP address.</span></span> 
    
- <span data-ttu-id="72faf-108">[ExpandGroup(EmailAddress)](http://msdn.microsoft.com/ru-ru/library/office/ee344007%28v=exchg.80%29.aspx) - расширяет группу, определенную с адресом электронной почты.</span><span class="sxs-lookup"><span data-stu-id="72faf-108">[ExpandGroup(EmailAddress)](http://msdn.microsoft.com/ru-ru/library/office/ee344007%28v=exchg.80%29.aspx) - Expands a group identified by an email address.</span></span> 
    
- <span data-ttu-id="72faf-109">[ExpandGroup(ItemId)](http://msdn.microsoft.com/ru-ru/library/office/ee356407%28v=exchg.80%29.aspx) - расширяет группу, определенную группу ID.</span><span class="sxs-lookup"><span data-stu-id="72faf-109">[ExpandGroup(ItemId)](http://msdn.microsoft.com/ru-ru/library/office/ee356407%28v=exchg.80%29.aspx) - Expands a group identified by a group ID.</span></span> 
    
- <span data-ttu-id="72faf-110">[ExpanGroup (строка, строка)](http://msdn.microsoft.com/ru-ru/library/office/ee356468%28v=exchg.80%29.aspx) - расширяет группу, определенную SMTP-адреса и типа маршрутизации этот адрес.</span><span class="sxs-lookup"><span data-stu-id="72faf-110">[ExpanGroup(String, String)](http://msdn.microsoft.com/ru-ru/library/office/ee356468%28v=exchg.80%29.aspx) - Expands a group identified by an SMTP address and the routing type of that address.</span></span> 
...
<span data-ttu-id="72faf-123">Так как группы контактов отсутствует адрес связанной электронной почты, вам нужно разверните группу на основании ItemId с помощью метода [ExpandGroup(ItemId)](http://msdn.microsoft.com/ru-ru/library/office/ee356407%28v=exchg.80%29.aspx) .</span><span class="sxs-lookup"><span data-stu-id="72faf-123">Because contact groups do not have an associated email address, you need to expand the group based on the ItemId by using the [ExpandGroup(ItemId)](http://msdn.microsoft.com/ru-ru/library/office/ee356407%28v=exchg.80%29.aspx) method.</span></span> <span data-ttu-id="72faf-124">Создание функции, как показано в предыдущем примере и измените второй тип параметра из строки на [идентификатор элемента](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.itemid%28v=exchg.80%29.aspx).</span><span class="sxs-lookup"><span data-stu-id="72faf-124">You can create a function, as shown in the previous example, and change the second parameter type from a string to an [ItemId](http://msdn.microsoft.com/ru-ru/library/microsoft.exchange.webservices.data.itemid%28v=exchg.80%29.aspx).</span></span>
