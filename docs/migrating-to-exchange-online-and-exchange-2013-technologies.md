...
Используйте приведенную ниже таблицу, чтобы определить, поддерживается ли технология разработки в Exchange Online или Exchange 2013. Если технология не поддерживается, ознакомьтесь со статьей [Выбор технологии разработки для переноса](#bk_choose).

<br/> 

**Технологии разработки и версии продуктов Exchange**

|Технологии|Office 365 и Exchange Online|Exchange 2013|Exchange 2010|Exchange 2007|
|:-----|:-----:|:-----:|:-----:|:-----:|
|[Общие сведения о платформе API Office 365](http://msdn.microsoft.com/library/16fbf0c0-5470-466b-aab8-a0c9074c94e2%28Office.15%29.aspx) <br/> |X  <br/> ||||
...
|[Веб-службы Exchange (EWS)](exchange-web-services/explore-the-ews-managed-api-ews-and-web-services-in-exchange.md) <br/> |X  <br/> |X  <br/> |X  <br/> |X  <br/> |
|[Почтовые приложения для Outlook](exchange-web-services/mail-apps-for-outlook-and-ews-in-exchange.md) <br/> |X  <br/> |X  <br/> |||
|[Объектная модель Outlook (некоторая)](http://msdn.microsoft.com/library/75e4ad96-62a2-49d2-bc51-48ceab50634c%28Office.15%29.aspx) <br/> |X  <br/> |X  <br/> |X  <br/> |X  <br/> |
...
|[API обмена сообщениями (MAPI)](http://msdn.microsoft.com/library/3d980b86-7001-4869-9780-121c6bfc7275%28Office.15%29.aspx) <br/> |X  <br/> |X  <br/> |X  <br/> |X  <br/> |
...
|**Технологии**|**Поддерживается в Office 365, Exchange Online и Exchange 2013?**|**Миграция в**|**Дополнительные сведения**|
|:-----|:-----|:-----|:-----|
|ИНТЕРФЕЙСЫ  <br/> |Да, без выделения <br/>|[Командная консоль Exchange](management/exchange-management-shell.md)<br/> |Нет.  <br/> |
...
|кдовф  <br/> |Нет  <br/> |[Windows Workflow Foundation (ВВФ)](http://msdn.microsoft.com/en-us/library/vstudio/ms735967%28v=vs.90%29.aspx) <br/> |Вы можете использовать ВВФ для создания сложных приложений рабочих процессов, работающих с Exchange 2007.   <br/> |
...
|Потоковая Архивация и восстановление  <br/> |Нет  <br/> |[Средство записи службы теневого копирования томов (VSS)](backup-restore/backup-and-restore-for-exchange-2013.md) <br/> |Нет.  <br/> |
...
- [Выбор API или технологии для разработки решений для Outlook](http://msdn.microsoft.com/library/01a46083-03d0-4333-920c-01a9f17f68cb%28Office.15%29.aspx)
