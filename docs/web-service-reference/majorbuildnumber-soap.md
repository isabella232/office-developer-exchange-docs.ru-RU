...
Элемент **MajorBuildNumber** представляет основной номер построения для сервера. 
...
Текстовое значение элемента MajorBuildNumber — целое число, представляющее основной номер сервера, на обработку запроса сборки.
