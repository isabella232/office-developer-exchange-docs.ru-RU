...
---
# <a name="majorbuildnumber-soap"></a>Мажорбуилднумбер (SOAP)

Элемент **мажорбуилднумбер** представляет основной номер сборки для сервера. 
...
Текстовое значение элемента Мажорбуилднумбер — это целое число, представляющее номер основной сборки сервера, который обработал запрос.
