...
description: Элемент MeetingRequest представляет запрос на собрание в Exchange магазине.
ms.openlocfilehash: 76bad3d920aa38bd2b7f42a9d0b30b8f01c8d1bd
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59542185"
---
# <a name="meetingrequest"></a>MeetingRequest

Элемент **MeetingRequest** представляет запрос на собрание в Exchange магазине. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[MimeContent](mimecontent.md) <br/> |Содержит родной поток многоцелевых расширений интернет-почты (MIME) объекта, представленного в формате base64Binary.  <br/> |
...
|[DisplayCc](displaycc.md) <br/> |Представляет строку отображения, используемую для содержимого строки CC. Это конкатуированная строка всех имен отображения получателей CC.  <br/> |
...
|[HasAttachments](hasattachments.md) <br/> |Представляет свойство, которое настроено на **верное,** если элемент имеет хотя бы одно видимое вложение. Это свойство только для чтения.  <br/> |
...
|[MeetingRequestType](meetingrequesttype.md) <br/> |Описывает тип запроса на собрание.  <br/> |
|[IntendedFreeBusyStatus](intendedfreebusystatus.md) <br/> |Представляет предполагаемый статус элемента календаря, связанного с запросом на собрание.  <br/> |
...
|[When](when.md) <br/> |Содержит описание того, когда происходит собрание.  <br/> |
...
|[ConflictingMeetingCount](conflictingmeetingcount.md) <br/> |Представляет количество собраний, которые конфликтуют с запросом на собрание.  <br/> |
...
|[ModifiedOccurrences](modifiedoccurrences.md) <br/> |Содержит массив повторяющихся вхождений элементов календаря, которые были изменены таким образом, чтобы они отличались от обычного элемента повторения.  <br/> Этот элемент действителен, [если значение CalendarItemType](calendaritemtype.md) имеет значение RecurringMaster.  <br/> |
...
|[AllowNewTimeProposal](allownewtimeproposal.md) <br/> |Представляет, может ли быть предложено новое время собрания для собрания.  <br/> |
