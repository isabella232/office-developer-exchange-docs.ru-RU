...
Элемент **TotalNumberOfPeopleInView** указывает общее число пользователей, возвращаемых в ответе **FindPeople** . 
...
Текстовое значение элемента **TotalNumberOfPeopleInView** — общее количество пользователей, возвращаемых в ответе **FindPeople** . 
