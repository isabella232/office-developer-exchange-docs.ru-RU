...
Элемент **SID** представляет форме безопасности определения дескриптора языке SDDL идентификатор безопасности (SID) для учетной записи для использования при олицетворении или передача прав доступа. 
...
|[Идентификатор пользователя](userid.md) <br/> |Идентифицирует пользователя делегатом или пользователь с правами доступа к папке.  <br/> |
   
## <a name="text-value"></a>Текстовое значение

Текстовое значение является строковое представление ИД безопасности.
