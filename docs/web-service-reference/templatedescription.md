...
---
# <a name="templatedescription"></a>темплатедескриптион

Элемент **темплатедескриптион** указывает описание шаблона управления правами. 
...
Текстовое значение элемента **темплатедескриптион** — описание шаблона управления правами, примененного к элементу. 
