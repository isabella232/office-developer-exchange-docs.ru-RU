...
Элемент **AttemptCount** представляет число попыток, которые были внесены индекс элемента. 
...
Значение элемента **AttemptCount** — это число попыток, которые были внесены индекс элемента. 
