...
---
# <a name="imagebase64-encryptionconfigurationresponsetype"></a>ImageBase64 (Енкриптионконфигуратионреспонсетипе)

Элемент **ImageBase64** предназначен только для внутреннего использования. 
