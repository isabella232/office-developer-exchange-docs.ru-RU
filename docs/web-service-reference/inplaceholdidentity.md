...
Элемент **InPlaceHoldIdentity** указывает идентификатор удержания, сохраняющий элементы почтового ящика. 
...
Текстовое значение элемента **InPlaceHoldIdentity** является идентификатором удержания почтового ящика. 
