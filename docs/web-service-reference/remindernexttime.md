...
Элемент **ReminderNextTime** указывает дату и время для следующей памятки. 
...
Текстовое значение для элемента **ReminderNextTime** — это дата и время следующего запланированного напоминание. 
