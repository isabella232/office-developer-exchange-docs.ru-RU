...
Элемент **GetClientAccessTokenResponseMessage** указывает сообщение ответа на запрос **GetClientAccessToken** . 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[Маркер (ClientAccessTokenType)](token-clientaccesstokentype.md) <br/> |Задает маркер доступа клиентов.  <br/> |
