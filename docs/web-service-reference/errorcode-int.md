...
---
# <a name="errorcode-int"></a>Код ошибки (int)

Элемент **ErrorCode** указывает код ошибки для неудачных поиска, выполненные с почтового ящика. 
...
Текстовое значение элемента **код ошибки** — это код ошибки для неудачных поиска, выполненные с почтового ящика. 
