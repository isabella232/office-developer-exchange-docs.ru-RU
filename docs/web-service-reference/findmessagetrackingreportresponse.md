...
---
# <a name="findmessagetrackingreportresponse"></a>финдмессажетраккингрепортреспонсе

Элемент **финдмессажетраккингрепортреспонсе** содержит состояние и результат одного запроса [операции FindMessageTrackingReport](findmessagetrackingreport-operation.md) . 
 ...
 **финдмессажетраккингрепортреспонсемессажетипе**
...
|[Диагностики](diagnostics.md) <br/> |Содержит сведения, которые будут использоваться для создания различных статистических отчетов для функции отслеживания в центре обработки данных.  <br/> |
|[мессажетраккингсеарчресултс](messagetrackingsearchresults.md) <br/> |Содержит и массив сообщений, которые отвечают требованиям поиска.  <br/> |
|[ексекутедсеарчскопе](executedsearchscope.md) <br/> |Содержит область поиска, выполненного для получения результатов поиска.  <br/> |
