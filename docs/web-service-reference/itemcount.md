...
description: Элемент ItemCount указывает общее число элементов в результатах поиска.
...
Элемент **ItemCount** указывает общее число элементов в результатах поиска. 
...
Текстовое значение элемента **ItemCount** определяет общее число элементов в результатах поиска. 
