...
Элемент **majorversion** представляет основной номер версии сервера. 
...
Текстовое значение для элемента **majorversion** — это целое число, представляющее основной номер версии сервера, который обработал запрос. 
