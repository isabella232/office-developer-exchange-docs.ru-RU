...
Элемент **MajorVersion** представляет основной номер версии для сервера. 
...
Текстовое значение для элемента **MajorVersion** — целое число, представляющее основной номер версии сервера, на котором обработать запрос. 
