...
description: Элемент References представляет заглавную ссылку Usenet, которая используется для связываний ответов с исходными сообщениями.
ms.openlocfilehash: a0889ed9ef7b96a2b2a78b9333b03f8efaafaf1f
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59523638"
---
# <a name="references"></a>Ссылки

Элемент **References** представляет заглавную ссылку Usenet, которая используется для связываний ответов с исходными сообщениями. 
...
Текстовое значение представляет загодер Usenet.
