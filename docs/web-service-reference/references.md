...
Элемент **References** представляет заголовок Usenet, используемый для связывания ответов с исходными сообщениями. 
...
Текстовое значение представляет заголовок Usenet.
