...
## <a name="disconnectphonecall-request-example"></a>Пример запроса На отключениеPhoneCall

### <a name="description"></a>Описание

В следующем примере **запроса DisconnectPhoneCall** показано, как сформировать запрос на отключение телефонного звонка. 
