...
Элемент **RecipientFilter** представляет адрес получателя для использования с заданным сообщением отслеживания отчета. 
...
|[RoutingType (EmailAddress)](routingtype-emailaddress.md) <br/> |Представляет протокол маршрутизации для данного получателя. Значение по умолчанию — SMTP. Этот элемент является необязательным.  <br/> |
