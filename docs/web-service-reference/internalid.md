...
Элемент **InternalId** представляет собой целое значение для идентификации события. 
...
Текстовое значение, представляющее целое число является обязательным, если данный элемент используется.
