...
Текстовое значение определяет сервер. Для протоколов, таких как POP3, IMAP, SMTP или NNTP это значение будет имя узла или IP-адрес. Для протоколов, таких как DAV или веб-это будет URL-адрес.
