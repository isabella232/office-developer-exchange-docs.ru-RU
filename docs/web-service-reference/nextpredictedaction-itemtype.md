...
---
# <a name="nextpredictedaction-itemtype"></a>Некстпредиктедактион (ItemType)

Элемент **некстпредиктедактион (ItemType)** предназначен только для внутреннего использования. 
