...
Элемент **ResponseMessages** содержит сообщений ответа на запрос веб-служб Exchange. 
...
|[UploadItemsResponseMessage](uploaditemsresponsemessage.md) <br/> |Содержит состояние и результаты одним запросом UploadItems.  <br/> |
|[ExportItemsResponseMessage](exportitemsresponsemessage.md) <br/> |Содержит состояние и результаты одним запросом ExportItems.  <br/> |
...
|[ExportItemsResponse](exportitemsresponse.md) <br/> |Представляет одного запроса ExportItems.  <br/> |
...
|[GetAttachmentResponse](getattachmentresponse.md) <br/> |Описывает ответ на запрос GetAttachment.  <br/> |
...
|[SubscribeResponse](subscriberesponse.md) <br/> |Определяет ответ на запрос подписки на.  <br/> |
...
|[UnsubscribeResponse](unsubscriberesponse.md) <br/> |Определяет ответ на запрос отказа от подписки.  <br/> |
...
|[ApplyConversationActionResponse](applyconversationactionresponse.md) <br/> |Определяет ответ на запрос [ApplyConversationAction операции](applyconversationaction-operation.md) .  <br/> |
|[GetPasswordExpirationDateResponse](getpasswordexpirationdateresponse.md) <br/> |Описывает ответ на запрос операции [GetPasswordExpirationDate операции](getpasswordexpirationdate-operation.md) .  <br/> |
