...
description: Элемент MeetingTime представляет собой рекомендуемый срок собрания.
...
Элемент **MeetingTime** представляет собой рекомендуемый срок собрания. 
...
Требуется текстовое значение, представляю которое **представляет значение dateTime.** 
  
## <a name="remarks"></a>Заметки

Элемент [MeetingTime](meetingtime.md) — это необходимый детский элемент элемента [Suggestion.](suggestion.md) 
