...
Элемент **MoveFolderResponseMessage** содержит состояние и результат одного запроса [MoveFolder операции](movefolder-operation.md) . 
...
|**Атрибут**|**Описание**|
|:-----|:-----|
|**ResponseClass** <br/> | Описание состояния ответа [операции MoveFolder](movefolder-operation.md) . <br/><br/>Для этого атрибута допустимы следующие значения:  <br/><br/>-Success  <br/>-Предупреждение  <br/>-Ошибка  <br/> |
...
|[Папки](folders-ex15websvcsotherref.md) <br/> |Содержит массив перемещенной папки.  <br/> |
