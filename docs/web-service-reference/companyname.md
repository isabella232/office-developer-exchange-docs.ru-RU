...
description: Элемент CompanyName представляет имя компании, связанное с контактом.
ms.openlocfilehash: 17c98d3cc1e4a3ec59477e771c50a0e6b2fd5f23
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59523190"
---
# <a name="companyname"></a>CompanyName

Элемент **CompanyName** представляет имя компании, связанное с контактом. 
