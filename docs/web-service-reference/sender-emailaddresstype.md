...
description: Элемент Sender представляет адрес электронной почты для отправитель сообщения.
ms.openlocfilehash: dbec27c3e21e956cf822821133ae8d435b5f2bfa
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59510871"
---
# <a name="sender-emailaddresstype"></a>Sender (EmailAddressType)

Элемент **Sender** представляет адрес электронной почты для отправитель сообщения. 
