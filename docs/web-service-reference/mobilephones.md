...
---
# <a name="mobilephones"></a>мобилефонес

Элемент **мобилефонес** указывает массив номеров мобильных телефонов и идентификаторы их исходных атрибутов для связанного пользователя. 
