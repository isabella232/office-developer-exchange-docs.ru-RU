...
---
# <a name="getroomsresponse"></a>жетрумсреспонсе

Элемент **жетрумсреспонсе** определяет ответ на запрос операции с запросом на получение [помещений](getrooms-operation.md) . 
...
|[Комната](rooms.md) <br/> |Предоставляет список адресов электронной почты и отображаемые имена, представляющие комнаты для собраний.  <br/> |
