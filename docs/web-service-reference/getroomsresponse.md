...
ms.locfileid: "59539952"
---
# <a name="getroomsresponse"></a>GetRoomsResponse

Элемент **GetRoomsResponse** определяет ответ на запрос [операции GetRooms.](getrooms-operation.md) 
...
|[Rooms](rooms.md) <br/> |Предоставляет список адресов электронной почты и отображает имена, которые представляют залы собраний.  <br/> |
