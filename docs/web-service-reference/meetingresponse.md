...
---
# <a name="meetingresponse"></a>митингреспонсе

Элемент **митингреспонсе** представляет ответ на приглашение на собрание в хранилище Exchange. 
