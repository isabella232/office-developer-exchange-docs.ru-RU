...
Элемент **IsFromMe** указывает ли пользователь отправить элемент его сами себя. 
...
Текстовое значение **true,** указывает, что элемент был отправлен пользователем, чтобы его сами себя. Значение **false** указывает, что элемент не отправлено пользователем в его сами себя. 
