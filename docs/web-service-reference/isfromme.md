...
Элемент **исфромме** указывает, отправил ли пользователь элемент. 
...
Текстовое значение **true** указывает, что элемент был отправлен пользователем. Значение **false** указывает, что элемент не был отправлен пользователем. 
