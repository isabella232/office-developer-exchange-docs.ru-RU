...
description: Элемент LegacyDn (FederatedDirectoryGroupType) предназначен только для внутреннего использования.
ms.openlocfilehash: dedd8e72c0ecfd946d866b28b4898603c1417fa3
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59514321"
---
# <a name="legacydn-federateddirectorygrouptype"></a>LegacyDn (FederatedDirectoryGroupType)

Элемент **LegacyDn (FederatedDirectoryGroupType)** предназначен только для внутреннего использования. 
