...
Элемент **IsOrganizer** задает логическое значение, указывающее, является ли этот человек организатора собрания. 
...
Текстовое значение **true** для элемента **IsOrganizer** указывает, что сообщение календаря элемента или собрания была создана пользователем. Значение **false** указывает, что сообщение собрание или элемент календаря не было создано bv пользователя. 
