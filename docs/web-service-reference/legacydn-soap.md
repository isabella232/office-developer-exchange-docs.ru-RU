...
Элемент **LegacyDN** представляет альтернативное различающееся имя устаревшего почтового ящика. 
...
Значение элемента **LegacyDN** является альтернативным различающимся именем прежнего почтового ящика. 
