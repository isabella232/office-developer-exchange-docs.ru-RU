...
---
# <a name="enddate-remindertype"></a>Дата окончания (ReminderType)

Элемент **EndDate** указывает, что дата окончания элемента напоминания предназначена для. 
...
Текстовое значение элемента **EndDate** — Дата окончания элемента. 
