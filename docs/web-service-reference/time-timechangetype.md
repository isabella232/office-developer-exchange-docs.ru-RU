...
---
# <a name="time-timechangetype"></a>Время (Тимечанжетипе)

Элемент **time** описывает время изменения времени между стандартным и летним временем. 
...
Текстовое значение представляет время, по истечении которого время меняется со стандартного времени на летнее.
