...
---
# <a name="time-timechangetype"></a>Время (TimeChangeType)

Элемент **времени** описывает времени, когда изменяется время между зимнего и летнего времени. 
...
Текстовое значение представляет время, когда изменяется время между зимнего и летнего времени.
