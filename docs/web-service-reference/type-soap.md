...
---
# <a name="type-soap"></a>Тип (SOAP)

Элемент **Type** представляет тип альтернативного почтового ящика. 
...
Текстовое значение элемента **Тип** — тип альтернативного почтового ящика. 
