...
Элемент **ParentInternetMessageId** указывает идентификатор сообщения Интернета родительского сообщения в беседе. 
...
Текстовое значение элемента **ParentInternetMessageId** — это идентификатор сообщения Интернета родительского сообщения в окне беседы. 
