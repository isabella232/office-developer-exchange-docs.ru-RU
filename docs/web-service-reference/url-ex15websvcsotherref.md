...
Элемент **URL-адрес** представляет расположение клиента веб-службы push-уведомлений. 
...
Текстовое значение элемента **URL-адрес** — это расположение клиента веб-службы push-уведомлений. 
