...
description: Элемент DisplayNameLastFirstHeader указывает заголовок для отображаемого имени и фамилии.
ms.openlocfilehash: eec9fe4de3a145b36423f123944972ea241e00d4
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59547521"
---
# <a name="displaynamelastfirstheader"></a>DisplayNameLastFirstHeader

Элемент **DisplayNameLastFirstHeader** указывает заголовок для отображаемого имени и фамилии. 
...
Текстовое значение элемента **DisplayNameLastFirstHeader** — это строковое значение, которое сначала указывает имя отображения, фамилию. 
