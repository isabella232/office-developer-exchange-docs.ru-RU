...
---
# <a name="persona"></a><span data-ttu-id="bea7a-103">Пользователь</span><span class="sxs-lookup"><span data-stu-id="bea7a-103">Persona</span></span>

<span data-ttu-id="bea7a-104">Элемент **пользователя** определяет набор данных пользователя, возвращаемых запросом **GetPersona** .</span><span class="sxs-lookup"><span data-stu-id="bea7a-104">The **Persona** element specifies a set of persona data returned by a **GetPersona** request.</span></span> 
