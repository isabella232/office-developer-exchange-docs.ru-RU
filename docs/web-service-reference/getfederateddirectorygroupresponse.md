...
---
# <a name="getfederateddirectorygroupresponse"></a>жетфедератеддиректориграупреспонсе

Элемент **жетфедератеддиректориграупреспонсе** предназначен только для внутреннего использования. 
