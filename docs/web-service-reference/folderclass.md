...
---
# <a name="folderclass"></a>фолдеркласс

Элемент **фолдеркласс** представляет класс Folder для папки. 
...
Необходимо указать текстовое значение. Классы папок обычно начинаются с "IPF".
