...
---
# <a name="mailtipsresponsemessagetype"></a>маилтипсреспонсемессажетипе

Элемент **маилтипсреспонсемессажетипе** представляет параметры советов по электронной почте. 
