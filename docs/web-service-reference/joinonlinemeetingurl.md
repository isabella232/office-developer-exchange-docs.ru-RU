...
Элемент **JoinOnlineMeetingUrl** указывает URL-адрес для присоединения к собранию по сети. 
...
Текстовое значение элемента **JoinOnlineMeetingUrl** — это URL-адрес собрания по сети. 
