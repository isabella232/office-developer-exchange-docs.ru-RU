...
---
# <a name="starttimezoneid"></a>старттимезонеид

Элемент **старттимезонеид** указывает часовой пояс, в котором выполняется собрание. 
...
Текстовое значение элемента **старттимезонеид** — это идентификатор часового пояса, используемого в [начальном](start.md) элементе. 
