...
---
# <a name="actions-arrayofsetclientextensionactionstype"></a>Действия (ArrayOfSetClientExtensionActionsType)

Элемент **Actions** определяет массив действий, выполняемых на клиентских расширений. 
...
[Действие (SetClientExtensionActionType)](action-setclientextensionactiontype.md)
