...
description: Элемент GetClientExtension представляет запрос на получение клиентское расширение.
...
Элемент **GetClientExtension** представляет запрос на получение клиентское расширение. 
