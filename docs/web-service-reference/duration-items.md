...
---
# <a name="duration-items"></a>Продолжительность (элементы)

Элемент **длительность** представляет длительность элемента календаря. 
...
Текстовое значение представляет длительность элемента календаря. Это свойство доступно только для чтения.
