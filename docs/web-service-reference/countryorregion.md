...
Элемент **страны** представляет страны или региона, для заданного физического адреса. 
...
Текстовое значение является значение типа string, представляющий имя страны.
