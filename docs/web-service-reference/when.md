...
Элемент **when** предоставляет сведения о том, когда встречается элемент "Календарь" или "собрание". 
...
Текстовое значение — это строка, которая описывает, когда происходит элемент календаря.
