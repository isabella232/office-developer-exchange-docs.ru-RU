...
**Когда** элемент предоставляет сведения о при возникновении календаря или элемент собрания. 
...
Текстовое значение — это строка, описывающая, когда происходит элемента календаря.
