...
Элемент **IsDefault** указывает, является ли документ, общий доступ к расположение пользователя по умолчанию, расположение для обмена. 
...
Логическое значение элемента **IsDefault** указывает, будет ли месту общего доступа пользователя по умолчанию, расположение для обмена. 
