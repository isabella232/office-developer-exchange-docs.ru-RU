...
description: Элемент CreateFolderPathResponse используется для возврата пути папки.
ms.openlocfilehash: f9539d794379ce54c6c7f13591b819d26890c618
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59520929"
---
# <a name="createfolderpathresponse"></a>CreateFolderPathResponse

Элемент **CreateFolderPathResponse** используется для возврата пути папки. 
