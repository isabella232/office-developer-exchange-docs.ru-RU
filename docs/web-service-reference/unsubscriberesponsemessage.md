...
---
# <a name="unsubscriberesponsemessage"></a>унсубскрибереспонсемессаже

Элемент **унсубскрибереспонсемессаже** содержит состояние и результат одного запроса на [отмену подписки](unsubscribe-operation.md) . 
