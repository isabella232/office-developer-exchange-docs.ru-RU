...
Элемент Ресетпинреспонсе определяет ответ на запрос для [операции ResetPIN (веб-служба единой системы обмена сообщениями)](resetpin-operation-um-web-service.md) . 
