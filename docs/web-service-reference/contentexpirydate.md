...
Элемент **ContentExpiryDate** Указывает срок действия содержимого. 
...
Текстовое значение элемента **ContentExpiryDate** — это строка, указывающая срок действия содержимого. 
