...
Элемент **UpdateFolder** представляет операцию, которая используется для обновления свойств для указанной папки. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[FolderChanges](folderchanges.md) <br/> |Содержит коллекцию изменений для указанной папки.  <br/> |
