...
Элемент **операцию UpdateFolder** представляет операцию, используемую для обновления свойств указанной папки. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[фолдерчанжес](folderchanges.md) <br/> |Содержит коллекцию изменений для указанной папки.  <br/> |
