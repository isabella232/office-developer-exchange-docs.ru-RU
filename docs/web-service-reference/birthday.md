...
---
# <a name="birthday"></a>День рождения

**День рождения** элемент представляет Дата рождения контакта. 
...
Текстовое значение, которое представляет дату и время является обязательным.
