...
---
# <a name="street"></a>Улица

**Название улицы** элемент представляет почтовый адрес для элемента контакта. 
...
Текстовое значение является строка, представляющая почтовый адрес контакта.
