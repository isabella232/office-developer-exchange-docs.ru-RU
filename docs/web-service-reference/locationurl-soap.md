...
Элемент **LocationUrl** представляет URL-адрес документа, общий доступ к расположения. 
...
Текстовое значение элемента **LocationUrl** — это URL-адрес документа, общий доступ к расположения. 
