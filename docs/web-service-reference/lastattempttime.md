...
Элемент **LastAttemptTime** содержит время и дату, с которого было выполнено последней попытки индекс элемента. 
...
Текстовое значение элемента **LastAttemptTime** представляет время и дату, с которого было выполнено последней попытки индекс элемента. 
