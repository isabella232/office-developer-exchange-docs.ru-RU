...
Элемент **NetShowUrl** указывает URL-адрес для Microsoft NetShow собрание по сети. 
...
Это свойство NetShowUrl чтения записи для организатора элемента календаря. Оно доступно только для чтения, для приглашений на собрания и участников.
