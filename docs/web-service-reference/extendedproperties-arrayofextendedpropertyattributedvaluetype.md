...
---
# <a name="extendedproperties-arrayofextendedpropertyattributedvaluetype"></a>Свойство ExtendedProperties (ArrayOfExtendedPropertyAttributedValueType)

Элемент **ExtendedProperties** содержит расширенные свойства, используемые для пользователя. 
