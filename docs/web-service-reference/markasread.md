...
Элемент **MarkAsRead** указывает ли сообщения должны быть отмечены как прочтенные. 
...
Текстовое значение **true,** указывает, что сообщения должны быть отмечены как прочтенные. Значение **false** указывает, что сообщения не должны быть отмечены как прочтенные. 
