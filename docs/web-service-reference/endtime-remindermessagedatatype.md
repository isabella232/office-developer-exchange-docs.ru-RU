...
---
# <a name="endtime-remindermessagedatatype"></a>Время окончания (ReminderMessageDataType)

Элемент **EndTime** представляет окончания интервала времени для запроса напоминания. 
...
Текстовое значение элемента **EndTime** представляет окончания интервала времени для запроса напоминания. 
