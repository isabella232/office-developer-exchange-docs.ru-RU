...
---
# <a name="proxypartnertoken"></a>проксипартнертокен

Элемент **проксипартнертокен** используется прокси-сервером HTTP компьютера, на котором работает Microsoft Exchange Server 2010, на котором установлена роль сервера клиентского доступа. Этот элемент не используется операциями веб-служб Exchange (EWS). 
