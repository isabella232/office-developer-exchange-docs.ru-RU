...
Элемент **домена** определяет одного домена SMTP. 
...
|IncludeSubdomains  <br/> |Указывает, считаются ли поддомены домена, определяемую средством атрибута **Name** внутренней. Этот атрибут является необязательным.  <br/> |
