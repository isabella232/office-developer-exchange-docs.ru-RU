...
Элемент **AuthRequired** указывает, будет ли проверка подлинности является обязательным. 
...
Текстовое значение определяет, будет ли проверка подлинности является обязательным. Возможные значения: **и **отключает**** . Если значение не указано, значение по умолчанию — **на**. 
