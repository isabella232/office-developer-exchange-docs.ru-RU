...
Элемент **AuthRequired** указывает, требуется ли проверка подлинности. 
...
Текстовое значение указывает, требуется ли проверка подлинности. Возможные **значения:** **On и on** . Если значение не указано, по умолчанию используется значение **On**. 
