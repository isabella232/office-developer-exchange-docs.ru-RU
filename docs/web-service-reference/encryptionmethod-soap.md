...
Элемент **EncryptionMethod** представляет метод шифрования, который используется для протоколов POP, IMAP и SMTP. 
...
Текстовое значение для этого элемента — это метод шифрования, который используется для протоколов POP, IMAP и SMTP.
