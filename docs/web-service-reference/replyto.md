...
Элемент **ReplyTo** определяет массив адресов, к которым будут отправляться ответы. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[Mailbox](mailbox.md) <br/> |Идентифицирует почты Active Directory объект службы каталогов отправлен ответ.  <br/> |
