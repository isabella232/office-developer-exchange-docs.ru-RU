...
description: Элемент NumberOfMembers представляет число пользователей, ресурсов и комнат в списке рассылки.
ms.openlocfilehash: d1a0f2afc1935f846dbe3d5ce1ba4385cf3cf8dd
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59529798"
---
# <a name="numberofmembers"></a>NumberOfMembers

Элемент **NumberOfMembers** представляет число пользователей, ресурсов и комнат в списке рассылки. 
...
Максимальное значение элемента **NumberOfMembers** — 100. 
