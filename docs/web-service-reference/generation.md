...
Элемент **создания** представляет поколениям аббревиатура, исходя из полного имени контакта. 
...
Этот элемент представляет те же данные, представленного свойство PR_Generation MAPI.
