...
---
# <a name="end-changehighlightstype"></a>Конец (ChangeHighlightsType)

Элемент **окончания** определяет изменения, внесенные в собрании завершение время, когда происходит обновление собрания. 
...
Текстовое значение **конечного** элемента — это новое время окончания собрания. 
