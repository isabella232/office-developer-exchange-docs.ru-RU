...
ms.locfileid: "59511876"
---
# <a name="createitemresponsemessage"></a>CreateItemResponseMessage

Элемент **CreateItemResponseMessage** содержит состояние и результат одного запроса [операции CreateItem.](createitem-operation.md) 
...
|**Атрибут**|**Описание**|
|:-----|:-----|
|**ResponseClass** <br/> | Описывает состояние ответа [операции CreateItem.](createitem-operation.md)<br/><br/>Для данного атрибута допустимы следующие значения:<br/><br/>–  Success  <br/>–  Warning  <br/>–  Error  <br/> |
...
|[Items](items.md) <br/> |Содержит массив созданных элементов.  <br/> |
