...
Элемент с **подписью** указывает, должны ли входящие сообщения быть подписаны для того, чтобы применялось условие или исключение. 
...
Текстовое значение **true** указывает, что сообщение должно быть подписано, чтобы применялось условие или исключение. Текстовое значение **false** указывает на то, что сообщение не обязательно должно быть подписано на условие или исключение, которое необходимо применить. 
