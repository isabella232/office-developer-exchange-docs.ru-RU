...
Элемент **YomiCompanyName** указывает имя названия компании японского связанного пользователя. 
...
Текстовое значение элемента **YomiCompanyName** — это имя названия компании японского связанного пользователя. 
