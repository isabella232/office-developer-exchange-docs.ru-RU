...
---
# <a name="alias-federateddirectorygrouptype"></a>Псевдоним (FederatedDirectoryGroupType)

**Псевдоним (FederatedDirectoryGroupType)** элемент предназначен только для внутреннего использования. 
