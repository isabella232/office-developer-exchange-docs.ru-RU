...
---
# <a name="alias-federateddirectorygrouptype"></a>Псевдоним (Федератеддиректориграуптипе)

Элемент **Alias (федератеддиректориграуптипе)** предназначен только для внутреннего использования. 
