...
Элемент **RelevanceScore** указывает целое число, представляющий как соответствующие связанного пользователя — клиенту. 
...
Текстовое значение элемента **RelevanceScore** является определение того, насколько пользователя для клиента. Этот элемент доступен только для чтения. 
