...
---
# <a name="calendarurl-mastermailboxtype"></a>CalendarUrl (Мастермаилбокстипе)

Элемент **CalendarUrl (мастермаилбокстипе)** предназначен только для внутреннего использования. 
