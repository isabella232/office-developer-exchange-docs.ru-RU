...
Элемент **CreateUserConfiguration** представляет запрос на создание объекта конфигурации пользователя. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[усерконфигуратион](userconfiguration.md) <br/> |Представляет один объект конфигурации пользователя.  <br/> |
