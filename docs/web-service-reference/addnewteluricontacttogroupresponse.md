...
Элемент **AddNewTelUriContactToGroupResponse** указывает данные результат операции WSDL **AddNewTelUriContactToGroup** . 
...
[Пользователь](persona.md) | [MessageText](messagetext.md) | [ResponseCode](responsecode.md) | [DescriptiveLinkKey](descriptivelinkkey.md)
