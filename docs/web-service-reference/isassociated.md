...
description: Элемент IsAssociated указывает, связан ли элемент с папкой.
ms.openlocfilehash: 39dbfd20b7d19f66bfe26a5587801c169cf148f0
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59512872"
---
# <a name="isassociated"></a>IsAssociated

Элемент **IsAssociated** указывает, связан ли элемент с папкой. 
...
Текстовое значение **true указывает** на то, что элемент связан с папкой; значение false **указывает,** что элемент не связан с папкой. 
