...
---
# <a name="getmessagetrackingreportresponse"></a>жетмессажетраккингрепортреспонсе

Элемент **жетмессажетраккингрепортреспонсе** содержит ответ для [операции GetMessageTrackingReport](getmessagetrackingreport-operation.md).
 ...
 **жетмессажетраккингрепортреспонсемессажетипе**
...
|[Диагностики](diagnostics.md) <br/> |Предоставляет сведения о времени и производительности, которые используются для отчетов в центре обработки данных.  <br/> |
|[сведения об ошибках](errors-ex15websvcsotherref.md); <br/> |Содержит контейнер свойств для хранения ошибок, возвращаемых через веб-службу.  <br/> |
