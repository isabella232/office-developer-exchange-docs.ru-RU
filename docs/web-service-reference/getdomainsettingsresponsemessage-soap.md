...
Элемент **жетдомаинсеттингсреспонсемессаже** содержит ответ на запрос [операции жетдомаинсеттингс (SOAP)](getdomainsettings-operation-soap.md) . 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[Отклик (SOAP)](response-soap.md) <br/> |Содержит ответ на запрос [операции жетдомаинсеттингс (SOAP)](getdomainsettings-operation-soap.md) .  <br/> |
