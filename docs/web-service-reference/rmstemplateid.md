...
---
# <a name="rmstemplateid"></a>рмстемплатеид

Элемент **рмстемплатеид** указывает идентификатор шаблона управления правами. 
...
Текстовое значение элемента **рмстемплатеид** — идентификатор шаблона управления правами. 
