...
Элемент **DebugData** содержит данные отладки для возврату ошибки службы автообнаружения. 
...
Текстовое значение представляет данные отладки для возврату ошибки службы автообнаружения.
