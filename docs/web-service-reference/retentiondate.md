...
Элемент **RetentionDate** указывает последнюю дату, на который должны сохраняться в элемент. 
...
Текстовое значение элемента **RetentionDate** представляет дату, когда, элемент больше не должны храниться. 
