...
---
# <a name="retentiondate"></a>ретентиондате

Элемент **ретентиондате** указывает последнюю дату, когда элемент должен быть сохранен. 
...
Текстовое значение элемента **ретентиондате** представляет дату, когда элемент больше не должен храниться. 
