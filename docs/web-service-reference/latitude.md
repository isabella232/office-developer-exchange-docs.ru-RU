...
description: Элемент широта указывает Широта расположения связанный почтовый адрес.
...
Элемент **широта** указывает Широта расположения связанный почтовый адрес. 
...
Текстовое значение элемента **широта** является широта связанный почтовый адрес. 
