...
---
# <a name="rooms"></a>Комната

Элемент **Rooms** представляет собой список из одного или нескольких элементов, представляющих комнаты для собраний. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[Комната](room.md) <br/> |Определяет адрес электронной почты и отображаемое имя, представляющее комнату для собраний.  <br/> |
   
### <a name="parent-elements"></a>Родительские элементы

|**Элемент**|**Описание**|
|:-----|:-----|
|[жетрумсреспонсе](getroomsresponse.md) <br/> ||
