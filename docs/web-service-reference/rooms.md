...
---
# <a name="rooms"></a>Комнат

Элемент **комнат** — список из одного или нескольких элементов, которые представляют комнаты для собраний. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[Комнаты](room.md) <br/> |Задает адрес электронной почты и отображаемое имя, которое представляет конференц-зала.  <br/> |
