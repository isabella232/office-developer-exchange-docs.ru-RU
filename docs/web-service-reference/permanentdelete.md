...
---
# <a name="permanentdelete"></a>перманентделете

Элемент **перманентделете** указывает, следует ли окончательно удалять сообщения и не сохранять их в папке "Удаленные". 
...
Текстовое значение **true** указывает на то, что сообщение должно быть помечено для окончательного удаления. Значение **false** указывает, что сообщение не должно быть помечено для окончательного удаления. 
