...
Элемент **PermanentDelete** указывает ли сообщений для окончательного удаления и не сохраняются в папку «Удаленные». 
...
Текстовое значение **true,** указывает, что сообщения должны быть отмечены будут окончательно удалены. Значение **false** указывает, что сообщение не должны быть отмечены будут окончательно удалены. 
