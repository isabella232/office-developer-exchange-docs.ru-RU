...
|[GetPhoneCallInformation](getphonecallinformation.md) <br/> |Представляет запрос на получение сведений о телефонный звонок.  <br/> |
|[PlayOnPhoneResponse (веб-служб Exchange)](playonphoneresponse-exchange-web-services.md) <br/> |Определяет ответ на запрос PlayOnPhone.  <br/> |
