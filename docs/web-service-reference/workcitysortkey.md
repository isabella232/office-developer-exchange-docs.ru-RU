...
Элемент **WorkCitySortKey** содержит ключ сортировки для значений рабочих Город, связанный с пользователя. 
...
Текстовое значение элемента **WorkCitySortKey** содержит ключ сортировки для сортировки свойства Город рабочей контактов, образующих пользователя. 
