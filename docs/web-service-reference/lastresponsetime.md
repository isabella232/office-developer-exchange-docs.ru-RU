...
Элемент **LastResponseTime** представляет дату и время последнего получен ответ. 
...
Текстовое значение, которое представляет дату и время последнего ответа является обязательным.
