...
description: Элемент UpdateFolderResponseMessage содержит состояние и результат обновлений, определенных элементом FolderChange запроса на операцию UpdateFolder.
ms.openlocfilehash: 1f86a056a6b12ff42fad6884c5de16b1412072f3
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59522399"
---
# <a name="updatefolderresponsemessage"></a>UpdateFolderResponseMessage

Элемент **UpdateFolderResponseMessage** содержит состояние и результат обновлений, определенных элементом [FolderChange](folderchange.md) запроса на операцию [UpdateFolder.](updatefolder-operation.md) 
...
|**Атрибут**|**Описание**|
|:-----|:-----|
|**ResponseClass** <br/> | Описывает состояние ответа операции [UpdateFolder.](updatefolder-operation.md) <br/><br/>Для данного атрибута допустимы следующие значения:  <br/><br/>–  Success  <br/>–  Warning  <br/>–  Error  <br/> |
