...
Элемент **ImItemList** содержит список групп мгновенного обмена сообщениями и обмена мгновенными сообщениями. 
...
[Группы (ArrayOfImGroupType)](groups-arrayofimgrouptype.md) | [пользователей](personas-ex15websvcsotherref.md)
