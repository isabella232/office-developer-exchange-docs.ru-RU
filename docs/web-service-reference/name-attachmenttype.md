...
---
# <a name="name-attachmenttype"></a>Имя (AttachmentType)

Элемент **Name** представляет имя вложения. 
...
Текстовое значение является значение типа string, представляющий имя вложения.
