...
description: Элемент GetUserConfigurationResponseMessage представляет ответ, возвращая объект конфигурации пользователя.
ms.openlocfilehash: 342d97aa34c3cd925114cf378b2cdbecbc9ca953
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59516841"
---
# <a name="getuserconfigurationresponsemessage"></a>GetUserConfigurationResponseMessage

Элемент **GetUserConfigurationResponseMessage** представляет ответ, возвращая объект конфигурации пользователя. 
...
|[UserConfiguration](userconfiguration.md) <br/> |Содержит один объект конфигурации пользователя.  <br/> |
