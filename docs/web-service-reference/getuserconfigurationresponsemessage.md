...
Элемент **GetUserConfigurationResponseMessage** представляет ответа, которое возвращает объект конфигурации пользователя. 
...
|[UserConfiguration](userconfiguration.md) <br/> |Содержит объект конфигурации одного пользователя.  <br/> |
