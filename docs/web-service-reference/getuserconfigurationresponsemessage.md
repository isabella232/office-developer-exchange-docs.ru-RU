...
---
# <a name="getuserconfigurationresponsemessage"></a>жетусерконфигуратионреспонсемессаже

Элемент **жетусерконфигуратионреспонсемессаже** представляет ответ, который возвращает объект конфигурации пользователя. 
 ...
 **жетусерконфигуратионреспонсемессажетипе**
...
|[усерконфигуратион](userconfiguration.md) <br/> |Содержит один объект конфигурации пользователя.  <br/> |
