...
description: Элемент DisclaimerText (SetEncryptionConfigurationType) предназначен только для внутреннего использования.
...
Элемент **DisclaimerText (SetEncryptionConfigurationType)** предназначен только для внутреннего использования. 
