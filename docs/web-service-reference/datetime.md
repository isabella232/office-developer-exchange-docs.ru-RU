...
Элемент **даты и времени** представляет дату и время, когда происходит переход часового пояса. 
...
Текстовое значение элемента **даты и времени** представляет дату и время, когда происходит переход часового пояса. 
