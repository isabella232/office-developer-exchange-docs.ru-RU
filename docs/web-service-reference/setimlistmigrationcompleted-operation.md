...
description: Операция SetImListMigrationCompleted не предназначен для использования общей.
...
Операция SetImListMigrationCompleted не предназначен для использования общей.
