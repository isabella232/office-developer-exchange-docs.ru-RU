...
---
# <a name="items-nonemptyarrayofuploaditemstype"></a>Элементы (NonEmptyArrayOfUploadItemsType)

Элемент **элементов** содержит массив элементов для передачи в почтовый ящик. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[UploadItems](uploaditems.md) <br/> |Представляет запрос для загрузки элементов в почтовом ящике.  <br/> |
