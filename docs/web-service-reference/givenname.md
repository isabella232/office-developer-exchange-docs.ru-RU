...
Элемент **GivenName** содержит имя контакта. 
...
Текстовое значение, представляющее имя контакта является обязательным, если данный элемент используется.
  
## <a name="remarks"></a>Замечания

Заданным именем обычно является имя другого пользователя.
