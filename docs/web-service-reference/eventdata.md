...
---
# <a name="eventdata"></a>Того

Элемент **того** представляет данные, связанные с шага обработки для события. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[Строка](string.md) <br/> |Содержит строку, которая определяет событие.  <br/> |
