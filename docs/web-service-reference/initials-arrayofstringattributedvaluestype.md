...
description: Элемент Initials указывает массив значений инициалов и идентификаторов их исходных атрибутов для связанной персоны.
...
Элемент **Initials** указывает массив значений инициалов и идентификаторов их исходных атрибутов для связанной персоны. 
