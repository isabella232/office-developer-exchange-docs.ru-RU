...
Элемент **языка и региональных параметров** представляет язык и региональные параметры для заданного элемента в почтовом ящике. 
...
Текстовое значение указывает язык, используемый в операциях веб-служб Exchange. Язык и региональные параметры, заданного с помощью идентификатора языка и региональных параметров RFC 1766; например en US.
