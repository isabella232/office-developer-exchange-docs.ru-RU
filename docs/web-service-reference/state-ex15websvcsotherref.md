...
Элемент **State** представляет состояние проживания элемента контакта. 
...
Строковое значение, представляющее имя состояния, является обязательным при использовании этого элемента.
