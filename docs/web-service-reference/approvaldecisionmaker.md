...
Элемент **ApprovalDecisionMaker** указывает отображаемое имя человека, который было принято утверждения. 
...
Текстовое значение элемента **ApprovalDecisionMaker** — это отображаемое имя. 
