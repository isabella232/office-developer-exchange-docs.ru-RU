...
---
# <a name="scope-clientaccesstokenrequesttype"></a>Область (ClientAccessTokenRequestType)

Элемент **области (ClientAccessTokenRequestType)** область маркеров. 
...
Текстовое значение элемента **области (ClientAccessTokenRequestType)** — это маркер области действия. 
