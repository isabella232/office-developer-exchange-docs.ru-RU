...
Элемент **Scope (клиентакцесстокенрекуесттипе)** задает область действия маркера. 
...
Текстовое значение элемента **Scope (клиентакцесстокенрекуесттипе)** является областью действия маркера. 
