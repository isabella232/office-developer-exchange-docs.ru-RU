...
Элемент **FoldersToIgnore** определяет список папок, которые используются, когда извлечение элементов в беседе. Все элементы беседы в игнорируемыми папок не возвращаются в ответ **GetConversationItems** . 
