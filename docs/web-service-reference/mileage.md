...
description: Элемент Mileage представляет пробег для задачи или контактного элемента.
ms.openlocfilehash: d16366eec875c1ea28241a942c35797280461d8d
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59512898"
---
# <a name="mileage"></a>Mileage

Элемент **Mileage** представляет пробег для задачи или контактного элемента. 
