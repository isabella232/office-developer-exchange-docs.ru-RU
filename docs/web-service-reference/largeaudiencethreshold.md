...
---
# <a name="largeaudiencethreshold"></a>ларжеаудиенцесрешолд

Элемент **ларжеаудиенцесрешолд** представляет пороговое значение большой аудитории для клиента. 
...
Текстовое значение — это целое число, представляющее пороговое значение аудитории, которое указывает, что сообщение отправляется более чем одному пользователю.
