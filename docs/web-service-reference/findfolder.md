...
## <a name="attributes-and-elements"></a><span data-ttu-id="b1cd4-106">Атрибуты и элементы</span><span class="sxs-lookup"><span data-stu-id="b1cd4-106">Attributes and elements</span></span>
