...
Элемент **TransitionsGroup** представляет массив переходы часового пояса. 
...
|**Атрибут**|**Описание**|
|:-----|:-----|
|Id  <br/> |Строковое значение, представляющее уникальный идентификатор группы между слайдами.  <br/> |
