...
description: Элемент RequestedConfiguration содержит запрашиваемую конфигурацию службы.
ms.openlocfilehash: 90279503e9db6a7bfffc111489442d58f51f6538
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59518997"
---
# <a name="requestedconfiguration"></a>RequestedConfiguration

Элемент **RequestedConfiguration содержит** запрашиваемую конфигурацию службы. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[ConfigurationName](configurationname.md) <br/> |Указывает запрашиваемую конфигурацию службы по имени.  <br/> |
