...
Элемент **GetUserSettingsRequestMessage** представляет запрос [GetUserSettings операции (SOAP)](getusersettings-operation-soap.md) . 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[Запрос (SOAP)](request-soap.md) <br/> |Содержит параметры конфигурации запрошенного.  <br/> |
