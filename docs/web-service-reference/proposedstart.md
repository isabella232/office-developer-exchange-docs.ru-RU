...
Элемент **ProposedStart** указывает время начала предложенного собрания. 
...
Текстовое значение элемента **ProposedStart** — это время начала предложенного, отправленных участниками организатора собрания. 
