...
---
# <a name="forwardallowed"></a>форвардалловед

Элемент **форвардалловед** указывает, включена ли переадресация сообщений электронной почты. 
...
Текстовое значение **true** для элемента **форвардалловед** указывает на то, что пересылка электронной почты разрешена. Значение **false** указывает, что пересылка не разрешена. 
