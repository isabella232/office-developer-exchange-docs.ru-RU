...
Элемент **HoldId** содержит идентификатор удержания почтового ящика. 
...
Текстовое значение элемента **HoldId** имеет уникальный идентификатор удержания почтового ящика. 
