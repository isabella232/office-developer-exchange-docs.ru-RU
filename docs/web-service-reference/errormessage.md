...
---
# <a name="errormessage"></a>Сообщение об ошибке

**Сообщение об ошибке** элемент представляет причину ошибки проверки. 
...
Сообщение об ошибке, связанный с ошибкой правила проверки.
