...
description: Элемент RefreshSharingFolderResponseMessage содержит состояние и результат одного запроса операции RefreshSharingFolder.
ms.openlocfilehash: 69a490027d98f1b2a320449c89fddd6f4f53c838
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59542863"
---
# <a name="refreshsharingfolderresponsemessage"></a>RefreshSharingFolderResponseMessage

Элемент **RefreshSharingFolderResponseMessage** содержит состояние и результат одного запроса операции [RefreshSharingFolder.](refreshsharingfolder-operation.md) 
