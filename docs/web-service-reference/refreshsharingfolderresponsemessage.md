...
---
# <a name="refreshsharingfolderresponsemessage"></a>рефрешшарингфолдерреспонсемессаже

Элемент **рефрешшарингфолдерреспонсемессаже** содержит состояние и результат одного запроса [операции RefreshSharingFolder](refreshsharingfolder-operation.md) . 
