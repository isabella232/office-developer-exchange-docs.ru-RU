...
Элемент **EmailAddresses** указывает массив сущностей, адрес электронной почты. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[EmailAddressEntity](emailaddressentity.md) <br/> |Указывает объект адрес одного адреса электронной почты.  <br/> |
