...
Элемент **суппортедфиликстенсионс** содержит расширения файлов, которые могут храниться в расположении общего доступа к документу. 
  
```XML
<SupportedFileExtensions /> 
```

 **аррайоффиликстенсион**
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[FileExtension (SOAP)](fileextension-soap.md) <br/> |Представляет расширение файла.  <br/> |
