...
Элемент **SupportedFileExtensions** список расширений файлов, которые могут храниться в документе общего ресурса. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[Добавляемое (SOAP)](fileextension-soap.md) <br/> |Представляет расширение файла.  <br/> |
