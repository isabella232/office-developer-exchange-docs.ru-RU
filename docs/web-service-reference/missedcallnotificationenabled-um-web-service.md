...
Элемент **MissedCallNotificationEnabled** содержит значение, указывающее, включено ли уведомление о пропущенном звонке в ответ на запрос [операции GetUMProperties (веб-служба единой системы обмена СООБЩЕНИЯМИ)](getumproperties-operation-um-web-service.md) . 
  
[GetUMPropertiesResponse (веб-служба единой системы обмена СООБЩЕНИЯМИ)](getumpropertiesresponse-um-web-service.md)
  
[MissedCallNotificationEnabled (веб-служба единой системы обмена СООБЩЕНИЯМИ)](missedcallnotificationenabled-um-web-service.md)
