...
Элемент **MissedCallNotificationEnabled** содержит значение, указывающее, включено ли уведомление о пропущенном звонке в ответ на запрос [веб-службы единой системы обмена сообщениями (GetUMProperties)](getumproperties-operation-um-web-service.md) . 
