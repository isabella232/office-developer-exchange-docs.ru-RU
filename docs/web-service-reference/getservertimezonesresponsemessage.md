...
description: Элемент GetServerTimeZonesResponseMessage содержит состояние и результат одного запроса на операцию GetServerTimeZones.
ms.openlocfilehash: 64f4669b4c6cd8c7e29cfa11c8b389be7f72fcd4
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59509800"
---
# <a name="getservertimezonesresponsemessage"></a>GetServerTimeZonesResponseMessage

Элемент **GetServerTimeZonesResponseMessage** содержит состояние и результат одного запроса на операцию [GetServerTimeZones.](getservertimezones-operation.md) 
...
|[TimeZoneDefinitions](timezonedefinitions.md) <br/> |Содержит массив определений часового пояса.  <br/> |
