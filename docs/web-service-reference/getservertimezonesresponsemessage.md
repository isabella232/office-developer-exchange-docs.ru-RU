...
Элемент **GetServerTimeZonesResponseMessage** содержит состояние и результат одного запроса [GetServerTimeZones операции](getservertimezones-operation.md) . 
...
|[TimeZoneDefinitions](timezonedefinitions.md) <br/> |Содержит массив определения часового пояса.  <br/> |
