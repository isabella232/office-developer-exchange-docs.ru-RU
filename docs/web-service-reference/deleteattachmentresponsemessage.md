...
Элемент **DeleteAttachmentResponseMessage** содержит состояние и результат одного запроса [DeleteAttachment операции](deleteattachment-operation.md) . 
...
|**Атрибут**|**Описание**|
|:-----|:-----|
|**ResponseClass** <br/> | Описание состояния ответа [операции DeleteAttachment](deleteattachment-operation.md) .<br/><br/>Для этого атрибута допустимы следующие значения:<br/><br/>-Success  <br/>-Предупреждение  <br/>-Ошибка  <br/> |
...
|[RootItemId](rootitemid.md) <br/> |Определяет родительский элемент удаленного вложения.  <br/> |
