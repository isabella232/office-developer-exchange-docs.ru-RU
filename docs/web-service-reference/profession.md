...
---
# <a name="profession"></a>Род занятий

**Род занятий** элемент представляет род занятий контакта. 
...
Текстовое значение, представляющее род занятий является обязательным.
