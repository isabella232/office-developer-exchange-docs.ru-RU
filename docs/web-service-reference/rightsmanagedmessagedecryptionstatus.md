...
Элемент **RightsManagedMessageDecryptionStatus** указывает состояние расшифровки управления правами элемента. 
...
Текстовое значение элемента **RightsManagedMessageDecryptionStatus** — состояние расшифровки прав защищенного элемента. 
