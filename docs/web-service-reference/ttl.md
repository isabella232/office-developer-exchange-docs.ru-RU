...
---
# <a name="ttl"></a>TTL (Срок жизни)

Элемент **TTL** указывает время действия маркера в минутах. 
...
Текстовое значение элемента **TTL** — это время в минутах, в течение которого токен является допустимым. 
