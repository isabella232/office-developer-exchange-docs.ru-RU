...
Элемент **IsMeeting** указывает, будет ли элемент календаря собрания или встречи. 
...
Текстовое значение, представляющее логическое значение является обязательным, если данный элемент включен. Значение **true** указывает на то, что элемент календаря собрания. Значение **false** указывает на то, что элемент календаря встречи. 
