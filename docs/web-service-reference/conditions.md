...
Элемент **условия** определяет условия, если выполнены, запустит действия правил для правила. 
...
|[ContainsHeaderStrings](containsheaderstrings.md) <br/> |Указывает строк, которые должны встречаться в заголовках входящих сообщений в порядке для условие или исключение для применения.  <br/> |
...
|[IsPermissionControlled](ispermissioncontrolled.md) <br/> |Указывает, должно ли быть в порядке для условие или исключение для применения входящие сообщения управляются разрешение (защищенные RMS).  <br/> |
