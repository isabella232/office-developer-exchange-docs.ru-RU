...
Элемент **NormalizedBodyType** указывает, возвращается ли нормализованный текст в формате HTML или текст. 
...
Текстовое значение элемента **NormalizedBodyType** указывает, что формат нормализованный body, возвращается в. В таблице ниже перечислены возможные варианты последнего. 
...
|HTML  <br/> |В ответе будут возвращены нормализованный body как HTML.  <br/> |
|Text  <br/> |В ответе будут возвращены нормализованный body как обычный текст.  <br/> |
