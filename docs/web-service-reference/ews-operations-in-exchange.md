...
Информация, содержащаяся в этом документе, может относиться к функциям и продуктам предварительной версии и может претерпеть значительные изменения до окончательного коммерческого выпуска. Настоящий документ предоставляется "как есть" и служит только для информационных целей. Корпорация Майкрософт не предоставляет никаких гарантий, явных или подразумеваемых, в связи с этим документом Сведения об операциях EWS, доступных в Exchange.
  
Веб-служб Exchange (EWS) предоставляет множество операций, которые позволяют получить доступ к информации из хранилища Exchange. Статьи в этом разделе представлены сведения об общей структуре запросы, ответы и сообщения об ошибках ответа для операций веб-служб Exchange, а также примеры XML для каждой операции. Они предоставляют обзор структур сообщения, отправленные между клиентом и сервером. Эти сведения можно использовать для отладки структуры сообщения и сведения о возможностях в запросе веб-служб Exchange. Дополнительные сведения о какие XML структуры представляет, см - [веб-служб Exchange XML-элементы в Exchange](ews-xml-elements-in-exchange.md).
