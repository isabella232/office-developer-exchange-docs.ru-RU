...
Элемент **GetSharingFolderResponse** определяет ответ на запрос [операции GetSharingFolder.](getsharingfolder-operation.md) 
