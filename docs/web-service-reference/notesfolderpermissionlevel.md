...
ms.locfileid: "59539264"
---
# <a name="notesfolderpermissionlevel"></a>NotesFolderPermissionLevel

Элемент **NotesFolderPermissionLevel** содержит разрешения для папки Заметки по умолчанию. Этот элемент появился в Exchange Server 2007 с пакетом обновления 1 (SP1). 
...
|:-----|:-----|
|Нет  <br/> |У пользователя делегирования нет разрешений доступа к папке Заметки.  <br/> |
|Reviewer  <br/> |Пользователь делегирования может читать элементы в папке Заметки.  <br/> |
|Автор  <br/> |Пользователь делегирования может читать и создавать элементы в папке Заметки.  <br/> |
|Редактор  <br/> |Пользователь делегирования может читать, создавать и изменять элементы в папке Заметки.  <br/> |
|Пользовательский сервер  <br/> |Пользователь делегирования имеет пользовательские разрешения доступа к папке Notes.  <br/> |
