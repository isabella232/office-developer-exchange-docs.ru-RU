...
---
# <a name="notes-contact"></a>Примечания (контактов)

Элемент **Notes** содержит дополнительные контактные данные. 
...
Текстовое значение является строка, представляющая дополнительных контактных данных.
