...
ms.locfileid: "59532556"
---
# <a name="meetingstring"></a>MeetingString

Элемент **MeetingString** указывает имя собрания в результате извлечения объекта. 
...
Текстовое значение элемента **MeetingString** — это имя собрания. 
