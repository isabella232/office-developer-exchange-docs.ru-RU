...
---
# <a name="replyallowed"></a>реплялловед

Элемент **реплялловед** указывает, разрешен ли ответ для данных, управляемых правами. 
...
Текстовое значение **true** для элемента **реплялловед** указывает на то, что ответы для данных, управляемых правами, разрешены. Значение **false** указывает, что ответы не разрешены. 
