...
Элемент **ReplyAllowed** указывающее, может ли ответ для правами управляемых данных. 
...
Текстовое значение **true** для элемента **ReplyAllowed** показывает, что ответы для права управляемых данных. Значение **false** указывает, что ответы не допускается. 
