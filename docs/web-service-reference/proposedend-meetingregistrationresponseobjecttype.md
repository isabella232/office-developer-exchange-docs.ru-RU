...
Элемент **ProposedEnd (MeetingRegistrationResponseObjectType)** Указывает участника предлагаемого новое время окончания собрания. 
...
Текстовое значение элемента **ProposedEnd (MeetingRegistrationResponseObjectType)** — это Предложенная дата и время окончания собрания. 
