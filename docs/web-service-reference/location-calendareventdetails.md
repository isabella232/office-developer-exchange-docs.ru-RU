...
---
# <a name="location-calendareventdetails"></a>Расположение (CalendarEventDetails)

Элемент **Location** представляет поля расположения элемента календаря. 
...
Текстовое значение является обязательным, если этот элемент возвращается в ответе. Этот элемент может содержать пустую строку. Этот элемент является обязательным, если используется элемент [CalendarEventDetails](calendareventdetails.md) . 
  
## <a name="remarks"></a>Замечания

Этот элемент сопоставляет PR_Location MAPI, именованное свойство.
