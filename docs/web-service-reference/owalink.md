...
Элемент **OwaLink** указывает ссылку, чтобы просмотреть элемента в Microsoft Outlook Web App. 
...
Текстовое значение элемента **OwaLink** — это URL-адрес для просмотра элемента в Outlook Web App. 
