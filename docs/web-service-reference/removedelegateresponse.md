...
Элемент **ремоведелегатереспонсе** содержит состояние и результат запроса [операции RemoveDelegate](removedelegate-operation.md) . 
 ...
 **ремоведелегатереспонсемессажетипе**
