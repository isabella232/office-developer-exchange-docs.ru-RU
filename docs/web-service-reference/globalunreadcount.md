...
---
# <a name="globalunreadcount"></a>глобалунреадкаунт

Элемент **глобалунреадкаунт** содержит количество непрочитанных элементов беседы в почтовом ящике. 
...
[глобалунреадкаунт](globalunreadcount.md)
...
Текстовое значение элемента **глобалунреадкаунт** — это целое число, представляющее количество всех непрочтенных элементов беседы в почтовом ящике. 
