...
ms.locfileid: "44530595"
---
# <a name="externaldirectoryobjectid-federateddirectoryidentitydetailstype"></a>ExternalDirectoryObjectId (Федератеддиректоридентитидетаилстипе)

Элемент **ExternalDirectoryObjectId (федератеддиректоридентитидетаилстипе)** предназначен только для внутреннего использования. 
