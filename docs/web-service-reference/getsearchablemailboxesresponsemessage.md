...
description: Элемент GetSearchableMailboxesResponseMessage указывает сообщение ответа для запроса GetSearchableMailboxes.
ms.openlocfilehash: 38287811f29a02f569769412a98afc293515b811
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59515840"
---
# <a name="getsearchablemailboxesresponsemessage"></a>GetSearchableMailboxesResponseMessage

Элемент **GetSearchableMailboxesResponseMessage** указывает сообщение ответа для запроса **GetSearchableMailboxes.** 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[SearchableMailboxes](searchablemailboxes.md) <br/> |Содержит массив почтовых ящиков, возвращаемых из **запроса GetSearchableMailboxes.**  <br/> |
