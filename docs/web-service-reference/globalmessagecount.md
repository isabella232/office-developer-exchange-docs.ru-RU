...
---
# <a name="globalmessagecount"></a>глобалмессажекаунт

Элемент **глобалмессажекаунт** содержит общее число элементов беседы в почтовом ящике. 
...
Текстовое значение элемента **глобалмессажекаунт** — это общее количество элементов беседы в почтовом ящике. 
