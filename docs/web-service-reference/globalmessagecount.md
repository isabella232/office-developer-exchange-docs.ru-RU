...
Элемент **GlobalMessageCount** содержит общее число элементов беседы в почтовом ящике. 
...
Текстовое значение элемента **GlobalMessageCount** — общее количество элементов беседы в почтовом ящике. 
