...
---
# <a name="playonphoneresponse-exchange-web-services"></a>PlayOnPhoneResponse (веб-служб Exchange)
...
|[PhoneCallId](phonecallid.md) <br/> |Задает идентификатор телефонный звонок.  <br/> |
