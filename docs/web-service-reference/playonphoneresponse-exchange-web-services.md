...
---
# <a name="playonphoneresponse-exchange-web-services"></a>PlayOnPhoneResponse (веб-службы Exchange)

Элемент **PlayOnPhoneResponse** указывает ответ на запрос на проигрывание голосовой почты по телефону. 
