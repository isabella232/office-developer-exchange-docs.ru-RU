...
Элемент **PageItemCount** указывает число страниц, возвращаемых в разбиение на страницы результатов поиска. 
...
Текстовое значение элемента **PageItemCount** — это число страниц, возвращаемых в разбиение на страницы результатов поиска. 
