...
---
# <a name="pageitemcount"></a>пажеитемкаунт

Элемент **пажеитемкаунт** указывает количество страниц, возвращаемых при разбивке результатов поиска. 
...
Текстовое значение элемента **пажеитемкаунт** — количество страниц, возвращаемых при разбивке результатов поиска. 
