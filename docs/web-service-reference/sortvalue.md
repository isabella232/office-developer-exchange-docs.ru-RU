...
Элемент **SortValue** указывает значение, используемое для сортировки. 
...
Текстовое значение элемента [SortValue](sortvalue.md) — это поле используется для сортировки результатов. 
