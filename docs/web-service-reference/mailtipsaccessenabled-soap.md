...
Элемент **MailTipsAccessEnabled** представляет флаг **MailTipsAccessEnabled()** . Элемент **MailTipsAccessEnabled** — только для внутреннего использования. Этот элемент не используется с клиентами. 
