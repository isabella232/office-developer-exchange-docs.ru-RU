...
Элемент **MoveItemResponseMessage** содержит состояние и результат одного запроса [MoveItem операции](moveitem-operation.md) . 
...
|**Атрибут**|**Описание**|
|:-----|:-----|
|**ResponseClass** <br/> | Описание состояния ответа [MoveItem операции](moveitem-operation.md) . <br/><br/>Для этого атрибута допустимы следующие значения:  <br/><br/>-Success  <br/>-Предупреждение  <br/>-Ошибка  <br/> |
...
|[Элементы](items.md) <br/> |Содержит массив перемещенной элементов.  <br/> |
