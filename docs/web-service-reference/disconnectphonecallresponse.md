...
---
# <a name="disconnectphonecallresponse"></a>дисконнектфонекаллреспонсе

Элемент **дисконнектфонекаллреспонсе** содержит состояние и результат одного запроса **DisconnectPhoneCall** . 
 ...
 **дисконнектфонекаллреспонсемессажетипе**
