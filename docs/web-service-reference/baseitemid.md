...
Элемент **басеитемид** представляет базовый класс для идентификаторов, представляющих элементы в почтовом ящике. Это абстрактный класс, и поэтому он не будет выполняться в экземпляре документа. 
...
Этот элемент является абстрактным базовым типом для идентификаторов элементов. Этот элемент не используется в вызовах веб-служб.
