...
Элемент **BaseItemId** представляет базовый класс для идентификаторы, представляющие элементов в почтовом ящике. Это абстрактный класс, поэтому не происходит в экземпляре документа. 
...
Этот элемент является абстрактный базовый тип для элемента идентификаторов. Этот элемент не используется в вызовы веб-службы.
