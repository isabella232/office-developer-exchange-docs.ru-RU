...
Элемент **UserRoles** указывает ролей пользователей, вызывающего пользователя или на уровне пользователя, вызывающий партнерское приложение используется в качестве, требуется применить текущий звонок. 
