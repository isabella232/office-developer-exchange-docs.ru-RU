...
---
# <a name="otheraddresses"></a>осераддрессес

Элемент **осераддрессес** указывает массив значений адреса и идентификаторы их исходных атрибутов для связанного пользователя. 
