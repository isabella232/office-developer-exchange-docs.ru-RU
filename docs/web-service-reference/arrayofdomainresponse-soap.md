...
---
# <a name="arrayofdomainresponse-soap"></a>Аррайофдомаинреспонсе (SOAP)

Элемент **аррайофдомаинреспонсе** содержит массив ответов для каждого параметра запрашиваемого домена. 
