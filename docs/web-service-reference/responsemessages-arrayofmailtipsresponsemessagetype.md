...
|**Элемент**|**Описание**|
|:-----|:-----|
|[GetMailTipsResponse](getmailtipsresponse.md) <br/> |Представляет сообщение ответа для [операции GetMailTips.](getmailtips-operation.md)  <br/> |
