...
Элемент **DeleteAttachment** является корневым элементом в запросе на удаление вложения из хранилища Exchange. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[AttachmentIds](attachmentids.md) <br/> |Содержит массив идентификаторов вложения, которые используются для удаления вложения.  <br/> |
