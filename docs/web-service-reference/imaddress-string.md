...
---
# <a name="imaddress-string"></a>ImAddress (строка)

Элемент **ImAddress** содержит основной обмена мгновенными сообщениями, адрес пользователя. 
...
Текстовое значение элемента **ImAddress** — это основной адрес для мгновенных сообщений пользователя. 
