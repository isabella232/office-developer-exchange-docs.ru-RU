...
Элемент **маилбокскултуре** указывает язык и региональные параметры, используемые при открытии почтового ящика. Этот элемент находится в заголовке SOAP. 
...
Текстовое значение указывает язык, используемый в операциях веб-службы Exchange. Возможные значения для этого элемента описаны в документе RFC 3066.
