...
Элемент **WorkCity** указывает город, где работает связанной пользователя. 
...
Текстовое значение элемента **WorkCity** — это название города, в котором работает связанной пользователя. 
