...
description: Элемент IsPinned (FederatedDirectoryGroupType) предназначен только для внутреннего использования.
ms.openlocfilehash: 4c4bd4ebf7c274438ba0c7e762144bda12f2aaf4
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59518248"
---
# <a name="ispinned-federateddirectorygrouptype"></a>IsPinned (FederatedDirectoryGroupType)

Элемент **IsPinned (FederatedDirectoryGroupType)** предназначен только для внутреннего использования. 
