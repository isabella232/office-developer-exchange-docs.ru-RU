...
Элемент **MeetingCancellation** представляет отмены собрания в хранилище Exchange. 
...
|[ReminderMinutesBeforeStart](reminderminutesbeforestart.md) <br/> |Представляет число минут и только потом события, что отображается напоминание.  <br/> |
