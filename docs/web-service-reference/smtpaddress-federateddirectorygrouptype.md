...
---
# <a name="smtpaddress-federateddirectorygrouptype"></a>SmtpAddress (Федератеддиректориграуптипе)

Элемент **SmtpAddress (федератеддиректориграуптипе)** предназначен только для внутреннего использования. 
