...
description: Элемент SmtpAddress (FederatedDirectoryGroupType) предназначен только для внутреннего использования.
ms.openlocfilehash: 60a0718e03ef48745aaa3861b04b566a67045869
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59539067"
---
# <a name="smtpaddress-federateddirectorygrouptype"></a>SmtpAddress (FederatedDirectoryGroupType)

Элемент **SmtpAddress (FederatedDirectoryGroupType)** предназначен только для внутреннего использования. 
