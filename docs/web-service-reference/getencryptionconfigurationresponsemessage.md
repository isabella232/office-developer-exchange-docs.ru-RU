...
---
# <a name="getencryptionconfigurationresponsemessage"></a>жетенкриптионконфигуратионреспонсемессаже

**Жетенкриптионконфигуратионреспонсемессаже** предназначен только для внутреннего использования. 
