...
---
# <a name="getitemresponsemessage"></a>жетитемреспонсемессаже

Элемент **жетитемреспонсемессаже** содержит состояние и результат одного запроса [операции GetItem](getitem-operation.md) . 
...
|**Атрибут**|**Описание**|
|:-----|:-----|
|**респонсекласс** <br/> | Описывает состояние ответа [операции GetItem](getitem-operation.md) . <br/><br/>Для этого атрибута допустимы следующие значения:<br/><br/>Успешное выполнение<br/>— Предупреждение<br/>— Ошибка |
...
|[Items](items.md) <br/> |Содержит массив возвращаемых элементов.  <br/> |
