...
Элемент **AdditionalInfo** указывает Дополнительные сведения о состояние удержания почтового ящика. 
...
|[NonIndexableItemDetail](nonindexableitemdetail.md) <br/> |Задает сведения для элемента, не могут быть индексированы.  <br/> |
   
## <a name="text-value"></a>Текстовое значение

Текстовое значение элемента AdditionalInfo, Дополнительные сведения о состояние удержания почтового ящика.
