...
Элемент **IsReadReceipt** указывает ли входящих сообщений должны быть прочтении в порядке для условие или исключение для применения. 
...
Текстовое значение **true,** указывает, что сообщения должны быть прочтении в порядке для условие или исключение для применения. Если сообщение не прочтении условие или исключение вступили в силу, значение — **false**.
