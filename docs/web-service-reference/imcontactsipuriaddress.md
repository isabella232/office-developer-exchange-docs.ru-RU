...
Элемент **ImContactSipUriAddress** содержит URI SIP-адрес контакта, который добавляется в мгновенное сообщение группе обмена Мгновенными сообщениями. 
...
Текстовое значение элемента **ImContactSipUriAddress** — это URI SIP-адрес контакта. 
