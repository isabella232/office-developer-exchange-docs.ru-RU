...
Элемент **аргумент** указывает аргументов, то действие. 
...
|**Атрибут**|**Описание**|
|:-----|:-----|
|**Значение** <br/> |Непустые строковое значение, представляющее значение аргумента действие частью правила защиты. Этот атрибут является обязательным.  <br/> |
