...
---
# <a name="childfoldercount"></a>чилдфолдеркаунт

Элемент **чилдфолдеркаунт** представляет количество непосредственных дочерних папок, содержащихся в папке. Это свойство доступно только для чтения. 
