...
```
 ...
 <span data-ttu-id="b07d1-108">**финдфолдерреспонсемессажетипе**</span><span class="sxs-lookup"><span data-stu-id="b07d1-108">**FindFolderResponseMessageType**</span></span>
