...
---
# <a name="getsharingmetadataresponse"></a>жетшарингметадатареспонсе

Элемент **жетшарингметадатареспонсе** определяет ответ на запрос [операции GetSharingMetadata](getsharingmetadata-operation.md) . 
