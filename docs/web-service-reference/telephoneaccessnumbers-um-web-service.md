...
Элемент **TelephoneAccessNumbers** содержит значение, — это список телефонных номеров, пользователи могут использовать для доступа к единой системе обмена сообщениями в виде, возвращаемом в ответ на запрос [операции GetUMProperties (веб-служба единой системы обмена СООБЩЕНИЯМИ)](getumproperties-operation-um-web-service.md) . 
