...
---
# <a name="getnonindexableitemdetailsresponse"></a>жетнониндексаблеитемдетаилсреспонсе

Элемент **жетнониндексаблеитемдетаилсреспонсе** указывает ответ на запрос **GetNonIndexableItemDetails** . 
