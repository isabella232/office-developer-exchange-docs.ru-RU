...
Элемент **Day** представляет день месяца, в который происходит переход часового пояса. 
...
Текстовое значение элемента **Day** — это целое число, представляющее день месяца, в который происходит переход часового пояса. 
