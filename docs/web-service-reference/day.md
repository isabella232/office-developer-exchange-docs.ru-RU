...
Элемент **Day** представляет день месяца, на котором происходит переход часового пояса. 
...
Текстовое значение элемента **день** — целое число, представляющее день месяца, на котором происходит переход часового пояса. 
