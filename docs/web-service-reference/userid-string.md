...
---
# <a name="userid-string"></a>Идентификатор пользователя (строка)

Элемент **UserId** указывает идентификатор пользователя для пользователя по электронной почте. 
...
Текстовое значение элемента **идентификатор пользователя** — это идентификатор пользователя по электронной почте. 
