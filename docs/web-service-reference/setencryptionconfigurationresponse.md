...
---
# <a name="setencryptionconfigurationresponse"></a>сетенкриптионконфигуратионреспонсе

Элемент **сетенкриптионконфигуратионреспонсе** предназначен только для внутреннего использования. 
