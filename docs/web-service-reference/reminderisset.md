...
Элемент **ReminderIsSet** указывает, установлен ли напоминания для элемента в хранилище Exchange. 
...
Текстовое значение **true,** указывает, что напоминание установлена. 
