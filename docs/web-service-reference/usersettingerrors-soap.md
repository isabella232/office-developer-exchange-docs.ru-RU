...
---
# <a name="usersettingerrors-soap"></a>Усерсеттинжеррорс (SOAP)

Элемент **усерсеттинжеррорс** представляет коллекцию сведений о параметрах, которые не удалось вернуть. 
