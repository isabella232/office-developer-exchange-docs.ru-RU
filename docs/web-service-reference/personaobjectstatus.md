...
Элемент **PersonaObjectStatus** определяет полные или неполные сведения, приведенные в связанного пользователя. 
...
Текстовое значение элемента **PersonaObjectStatus** указывает, является ли он полный или сокращенный. 
