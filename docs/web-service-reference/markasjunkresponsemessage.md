...
description: Элемент MarkAsJunkResponseMessage указывает сообщение ответа на запрос MarkAsJunk.
...
Элемент **MarkAsJunkResponseMessage** указывает сообщение ответа на запрос **MarkAsJunk** . 
