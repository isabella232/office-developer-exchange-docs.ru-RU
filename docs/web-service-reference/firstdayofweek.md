...
Текстовое значение элемента **FirstDayOfWeek** указывает, какой день недели используется в качестве первого дня недели. Ниже приведены возможные текстовые значения. 
