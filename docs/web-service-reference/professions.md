...
---
# <a name="professions"></a>Профессии

Элемент **профессииs** указывает массив значений **профессии** и идентификаторы их исходных атрибутов для связанного пользователя. 
