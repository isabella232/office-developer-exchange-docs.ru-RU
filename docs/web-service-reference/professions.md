...
---
# <a name="professions"></a>Профессиях

Элемент **профессиях** указывает массив значений **род занятий** и идентификаторы их атрибуты источника для связанного пользователя. 
