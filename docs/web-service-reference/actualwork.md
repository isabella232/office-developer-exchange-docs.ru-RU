...
Элемент **ActualWork** представляет фактический объем времени, затраченного на выполнение задачи. 
...
Текстовое значение для этого элемента представляет собой целое число.
