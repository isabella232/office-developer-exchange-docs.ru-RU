...
---
# <a name="externalaccessallowed-soap"></a>Екстерналакцессалловед (SOAP)

Элемент **екстерналакцессалловед** указывает, доступно ли расположение для общего доступа к документам для внешнего подключения. 
...
Логическое значение элемента **екстерналакцессалловед** указывает, доступно ли расположение общего доступа для внешнего подключения. 
