...
Это свойство доступно только для чтения. В следующей таблице приведены возможные значения.
  
|**Значение**|**Описание**|
|:-----|:-----|
|0  <br/> |По умолчанию для всех элементов задачи.  <br/> |
|1  <br/> |Запрос задачи.  <br/> |
|2  <br/> |Принятие задачи от получателя запроса на задачу.  <br/> |
|3  <br/> |Задача отказ от получателя запроса на задачу.  <br/> |
|4  <br/> |Обновление предыдущих запроса на задачу.  <br/> |
