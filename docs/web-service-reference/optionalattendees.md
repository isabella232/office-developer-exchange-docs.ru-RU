...
description: Элемент OptionalAttendees представляет участников, которые не обязаны присутствовать на собрании.
ms.openlocfilehash: 66ccaf560d251be7a314d6abb9f9635c03a2a373
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59543158"
---
# <a name="optionalattendees"></a>OptionalAttendees

Элемент **OptionalAttendees представляет** участников, которые не обязаны присутствовать на собрании. 
