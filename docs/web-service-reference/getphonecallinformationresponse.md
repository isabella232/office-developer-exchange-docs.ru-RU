...
description: Элемент GetPhoneCallInformationResponse определяет ответ на один запрос GetPhoneCallInformation.
ms.openlocfilehash: a23c8516765cf3b273448745bb31a653222143a2
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59539931"
---
# <a name="getphonecallinformationresponse"></a>GetPhoneCallInformationResponse

Элемент **GetPhoneCallInformationResponse** определяет ответ на один запрос GetPhoneCallInformation. 
