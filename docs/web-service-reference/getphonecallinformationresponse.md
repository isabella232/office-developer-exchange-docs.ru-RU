...
---
# <a name="getphonecallinformationresponse"></a>жетфонекаллинформатионреспонсе

Элемент **жетфонекаллинформатионреспонсе** определяет ответ на один запрос GetPhoneCallInformation. 
 ...
 **жетфонекаллинформатионреспонсемессажетипе**
