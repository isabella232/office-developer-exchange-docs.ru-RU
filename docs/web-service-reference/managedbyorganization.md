...
Элемент **ManagedByOrganization** указывает Управление организацией. 
...
Текстовое значение элемента **ManagedByOrganization** определяет организации, который управляет поиска обнаружения. 
