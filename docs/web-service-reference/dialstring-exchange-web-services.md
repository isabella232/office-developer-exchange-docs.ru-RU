...
Элемент **DialString** представляет строку телефонные номера телефона, который вызывается для воспроизведения элемента по телефону. Этот элемент обязательный. 
