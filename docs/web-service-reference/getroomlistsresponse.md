...
description: Элемент GetRoomListsResponse определяет ответ из запроса на операцию GetRoomLists.
ms.openlocfilehash: 4b8eb3cc596debd1110849ac10edaed9308708f3
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59518304"
---
# <a name="getroomlistsresponse"></a>GetRoomListsResponse

Элемент **GetRoomListsResponse** определяет ответ из запроса на операцию [GetRoomLists.](getroomlists-operation.md) 
...
|[RoomLists](roomlists.md) <br/> |Предоставляет список адресов электронной почты и отображает имена, которые представляют списки комнат собраний.  <br/> |
