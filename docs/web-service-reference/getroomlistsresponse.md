...
---
# <a name="getroomlistsresponse"></a>жетрумлистсреспонсе

Элемент **жетрумлистсреспонсе** определяет ответ на запрос [операции GetRoomLists](getroomlists-operation.md) . 
 ...
 **жетрумлистсреспонсемессажетипе**
...
|[румлистс](roomlists.md) <br/> |Предоставляет список адресов электронной почты и отображаемых имен, представляющих списки комнат для собраний.  <br/> |
