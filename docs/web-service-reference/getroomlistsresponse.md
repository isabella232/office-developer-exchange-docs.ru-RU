...
Элемент **GetRoomListsResponse** определяет ответа от [GetRoomLists операции](getroomlists-operation.md) . 
...
|[RoomLists](roomlists.md) <br/> |Предоставляет список адресов электронной почты и отображаемые имена, которые представляют списки конференц-залы.  <br/> |
