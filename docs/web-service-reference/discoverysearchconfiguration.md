...
Элемент **DiscoverySearchConfiguration** указывает конфигурацию для поиска обнаружения электронных данных. 
...
|[SearchQuery](searchquery.md) <br/> |Указывает имя запроса поиска eDiscovery.  <br/> |
|[SearchableMailboxes](searchablemailboxes.md) <br/> |Содержит список почтовых ящиков, возвращаемый запросом **GetSearchableMailboxes** .  <br/> |
