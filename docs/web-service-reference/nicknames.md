...
---
# <a name="nicknames"></a>Псевдонимы

Элемент **псевдонимы** указывает массив значений псевдонимов и идентификаторы их атрибуты источника для связанного пользователя. 
