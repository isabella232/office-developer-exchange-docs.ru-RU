...
---
# <a name="mailbox-previewitemmailboxtype"></a>Почтовый ящик (Превиевитеммаилбокстипе)

Элемент **Mailbox** содержит идентификатор почтового ящика и основной SMTP-адрес пользователя. 
