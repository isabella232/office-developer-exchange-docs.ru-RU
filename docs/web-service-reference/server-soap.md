...
---
# <a name="server-soap"></a>Сервер (SOAP)

Элемент **Server** представляет сервер альтернативного почтового ящика. 
...
Текстовое значение элемента **сервера** — это имя сервера, альтернативного почтового ящика. 
