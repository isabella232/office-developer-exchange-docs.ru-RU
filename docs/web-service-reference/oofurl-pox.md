...
Элемент **OOFUrl** указывает URL-адрес наиболее экземпляр службы доступности для пользователя с включенной поддержкой почты. 
...
Текстовое значение указывает URL-адрес сервера отсутствии конфигурации для топологии Exchange.
