...
Элемент **ClientExtensions** содержит массив пользователя и настройки сведений о приложениях. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[GetClientExtensionResponse](getclientextensionresponse.md) <br/> |Представляет ответа для получения сведений о приложении конфигурации.  <br/> |
