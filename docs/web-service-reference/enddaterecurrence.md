...
Элемент **EndDateRecurrence** описание, Дата начала и Дата окончания повторения элемента. 
...
|[Дата окончания (повторения)](enddate-recurrence.md) <br/> |Представляет дату окончания повторяющейся задачи или элемента календаря.  <br/> |
...
|[Повторение (TaskRecurrenceType)](recurrence-taskrecurrencetype.md) <br/> |Содержит шаблон повторения для повторяющихся задач.  <br/> |
