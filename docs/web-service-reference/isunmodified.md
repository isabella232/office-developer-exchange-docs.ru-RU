...
description: Элемент IsUnmodified указывает, был ли элемент изменен.
ms.openlocfilehash: 10d121894a2c560d9ccbcf9fa8387ac8660600aa
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59519480"
---
# <a name="isunmodified"></a>IsUnmodified

Элемент **IsUnmodified** указывает, был ли элемент изменен. 
...
Значение текстового **значения true** указывает на то, что элемент неизменен. Ложное **текстовое** значение указывает, что элемент был изменен. 
