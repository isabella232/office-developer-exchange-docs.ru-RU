...
Элемент **исунмодифиед** указывает, был ли изменен элемент. 
...
Текстовое значение **true** указывает, что элемент не изменен. Текстовое значение **false** указывает, что элемент был изменен. 
