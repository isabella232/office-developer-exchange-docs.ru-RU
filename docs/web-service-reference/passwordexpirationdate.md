...
Элемент **PasswordExpirationDate** предоставляет срок действия пароля для учетной записи почтового ящика. 
...
|:-----|:-----|
|[Операция GetPasswordExpirationDate](getpasswordexpirationdate-operation.md) <br/> |Определяет запрос на получение срок действия пароля для учетной записи электронной почты.  <br/> |
