...
Элемент **PhoneNumbers** представляет коллекцию телефонных номеров контакта. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[Запись (PhoneNumber)](entry-phonenumber.md) <br/> |Представляет номер телефона контакта.  <br/> |
