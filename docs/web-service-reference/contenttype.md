...
Элемент **ContentType** описывает тип Multipurpose Internet Mail Extensions (MIME) для содержимого вложения. 
...
Текстовое значение является значение типа string, представляющий тип контента вложения.
