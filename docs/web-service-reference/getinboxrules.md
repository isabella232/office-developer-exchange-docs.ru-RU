...
|**Элемент**|**Описание**|
|:-----|:-----|
|[маилбокссмтпаддресс](mailboxsmtpaddress.md) <br/> |Представляет SMTP-адрес пользователя, чьи правила папки "Входящие", нужно вернуть.  <br/> |
