...
Элемент **ReminderMinutesBeforeStart** представляет число минут, прежде чем событие происходит, когда отображается напоминание. 
...
Текстовое значение представляет в минутах время до событие происходит, когда отображается напоминание.
