...
---
# <a name="updatefolderresponse"></a>упдатефолдерреспонсе

Элемент **упдатефолдерреспонсе** определяет ответ на запрос операцию UpdateFolder. 
