...
---
# <a name="getsharingfolderresponsemessage"></a>жетшарингфолдерреспонсемессаже

Элемент **жетшарингфолдерреспонсемессаже** содержит состояние и результат одного запроса [операции GetSharingFolder](getsharingfolder-operation.md) . 
