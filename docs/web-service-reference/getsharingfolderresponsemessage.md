...
description: Элемент GetSharingFolderResponseMessage содержит состояние и результат одного запроса на операцию GetSharingFolder.
ms.openlocfilehash: 6eb95ea779b003021cd51a4fa31a8d30440da21b
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59515833"
---
# <a name="getsharingfolderresponsemessage"></a>GetSharingFolderResponseMessage

Элемент **GetSharingFolderResponseMessage** содержит состояние и результат одного запроса на операцию [GetSharingFolder.](getsharingfolder-operation.md) 
