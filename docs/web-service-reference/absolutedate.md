...
Элемент **AbsoluteDate** представляет дату, когда изменяется время от стандартное или летнее время. 
...
Текстовое значение представляет дату, когда происходит shift между стандартное или летнее время.
