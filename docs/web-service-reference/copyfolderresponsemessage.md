...
description: Элемент CopyFolderResponseMessage содержит состояние и результат одного запроса операции CopyFolder.
ms.openlocfilehash: 568a907dacf5642834a600704130305411919622
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59515945"
---
# <a name="copyfolderresponsemessage"></a>CopyFolderResponseMessage

Элемент **CopyFolderResponseMessage** содержит состояние и результат одного запроса операции [CopyFolder.](copyfolder-operation.md) 
...
|**Атрибут**|**Описание**|
|:-----|:-----|
|**ResponseClass** <br/> | Описывает состояние ответа операции [CopyFolder.](copyfolder-operation.md)<br/><br/>Для данного атрибута допустимы следующие значения:<br/><br/>- Успех  <br/>–  Warning  <br/>–  Error  <br/> |
...
|[Folders](folders-ex15websvcsotherref.md) <br/> |Содержит массив скопированные папки.  <br/> |
