...
Элемент **DisplayNameFirstLastHeader** указывает заголовок в поле отображаемое имя, имя сначала. 
...
Текстовое значение элемента **DisplayNameFirstLastHeader** — это строковое значение, задающее заголовок. 
