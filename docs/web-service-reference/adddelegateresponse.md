...
description: Элемент AddDelegateResponse содержит состояние и результат запроса операции AddDelegate.
ms.openlocfilehash: 2e630d42b004f6c7ccaf7cc2240369dcf312068b
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59544396"
---
# <a name="adddelegateresponse"></a>AddDelegateResponse

Элемент **AddDelegateResponse содержит** состояние и результат запроса операции [AddDelegate.](adddelegate-operation.md) 
