...
description: Элемент SubmitTime представляет время отправки сообщения на сервер.
ms.openlocfilehash: 8a6a70da6a59942b13f5000666fd7581ce65bf37
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59537386"
---
# <a name="submittime"></a>SubmitTime

Элемент **SubmitTime** представляет время отправки сообщения на сервер. 
