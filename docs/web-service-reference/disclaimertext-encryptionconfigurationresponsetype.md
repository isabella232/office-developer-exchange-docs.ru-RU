---
title: DisclaimerText (Енкриптионконфигуратионреспонсетипе)
manager: sethgros
ms.date: 11/16/2014
...
Элемент **DisclaimerText (енкриптионконфигуратионреспонсетипе)** предназначен только для внутреннего использования. 
