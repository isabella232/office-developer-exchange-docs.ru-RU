...
description: Элемент MiddleName представляет второе имя контакта.
ms.openlocfilehash: a9f4f08828c4cbcaa930a5f517f1315f87b05506
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59510913"
---
# <a name="middlename"></a>MiddleName

Элемент **MiddleName** представляет второе имя контакта. 
...
Строка, представляюная среднее имя контакта.
