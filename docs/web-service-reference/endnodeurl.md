...
Элемент **EndNodeUrl** указывает URL-адрес для почтового приложения в магазине Office. 
...
Текстовое значение элемента **EndNodeUrl** — это URL-адрес для почтового приложения в магазине Office. 
