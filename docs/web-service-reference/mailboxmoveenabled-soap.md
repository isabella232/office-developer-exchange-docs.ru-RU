...
Элемент **MailBoxMoveEnabled** представляет флаг **MailboxMoveEnabled()** . Элемент **MailBoxMoveEnabled** — только для внутреннего использования. Этот элемент не используется с клиентами. 
