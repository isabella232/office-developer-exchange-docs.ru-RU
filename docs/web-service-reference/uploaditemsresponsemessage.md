...
---
# <a name="uploaditemsresponsemessage"></a>уплоадитемсреспонсемессаже

Элемент **уплоадитемсреспонсемессаже** содержит состояние и результаты запроса на отправку одного элемента почтового ящика. 
 ...
 **уплоадитемсреспонсемессажетипе**
...
|[Идентификатор](itemid.md) <br/> |Содержит идентификатор элемента отправленного элемента.  <br/> |
