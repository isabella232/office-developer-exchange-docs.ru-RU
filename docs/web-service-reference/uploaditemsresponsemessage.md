...
description: Элемент UploadItemsResponseMessage содержит состояние и результаты запроса на отправку одного элемента почтового ящика.
...
Элемент **UploadItemsResponseMessage** содержит состояние и результаты запроса на отправку одного элемента почтового ящика. 
...
|[ItemId](itemid.md) <br/> |Содержит идентификатор элемента загруженного элемента.  <br/> |
