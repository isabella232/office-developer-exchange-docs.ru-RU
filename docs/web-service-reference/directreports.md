...
Элемент **DirectReports** содержит сведения о SMTP, идентифицирующее прямые отчеты контакт. 
...
|:-----|:-----|
|[Контакт](contact.md) <br/> |Представляет контактные элемента в хранилище Exchange.  <br/> |
