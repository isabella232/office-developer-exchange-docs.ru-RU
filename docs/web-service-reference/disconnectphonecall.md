...
Элемент **DisconnectPhoneCall** представляет запрос на отключение вызова. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[фонекаллид](phonecallid.md) <br/> |Задает идентификатор вызова для отключения. Этот элемент обязательный.  <br/> |
