...
---
# <a name="mailboxtype-mastermailboxtype"></a>MailboxType (Мастермаилбокстипе)

Элемент **MailboxType (мастермаилбокстипе)** предназначен только для внутреннего использования. 
