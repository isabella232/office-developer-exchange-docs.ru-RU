...
description: Элемент Departments указывает массив имен отделов и идентификаторов их исходных атрибутов для связанной персоны.
ms.openlocfilehash: 9c0cc12777b03d7fa8499579907f4ba2184931e7
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59546667"
---
# <a name="departments"></a>Departments

Элемент **Departments** указывает массив имен отделов и идентификаторов их исходных атрибутов для связанной персоны. 
