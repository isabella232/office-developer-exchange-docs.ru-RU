...
---
# <a name="replyalltoitem"></a>репляллтоитем

Элемент **реплитоаллитем** содержит ответ на отправителя и всех идентифицированных получателей элемента в хранилище Exchange. 
