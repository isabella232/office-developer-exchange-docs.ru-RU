...
description: Элемент ReplyToAllItem содержит ответ отправителю и всем идентифицированным получателям элемента в Exchange магазине.
ms.openlocfilehash: 33dc348686e99e4f21b67b18780a6a6691a7d72a
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59519018"
---
# <a name="replyalltoitem"></a>ReplyAllToItem

Элемент **ReplyToAllItem** содержит ответ отправителю и всем идентифицированным получателям элемента в Exchange магазине. 
