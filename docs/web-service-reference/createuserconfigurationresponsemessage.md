...
---
# <a name="createuserconfigurationresponsemessage"></a>креатеусерконфигуратионреспонсемессаже

Элемент **креатеусерконфигуратионреспонсемессаже** содержит состояние и результат одного запроса **CreateUserConfiguration** . 
