...
---
# <a name="deleteuserconfigurationresponsemessage"></a>делетеусерконфигуратионреспонсемессаже

Элемент **делетеусерконфигуратионреспонсемессаже** содержит состояние и результат одного запроса **DeleteUserConfiguration** . 
