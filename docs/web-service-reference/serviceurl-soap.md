...
Элемент **сервицеурл** представляет URL-адрес веб-службы общего доступа к документам. 
...
Текстовое значение элемента **сервицеурл** — URL-адрес веб-службы общего доступа к документам. 
