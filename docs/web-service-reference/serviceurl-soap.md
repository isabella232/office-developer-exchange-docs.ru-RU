...
Элемент **ServiceUrl** представляет URL-адрес документа, общий доступ к веб-службе. 
...
Текстовое значение элемента **ServiceUrl** — это URL-адрес документа, общий доступ к веб-службе. 
