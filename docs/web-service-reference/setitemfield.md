...
description: Элемент SetItemField представляет обновление одного свойства элемента в операции UpdateItem.
ms.openlocfilehash: ab54bf10fb457ff92dfb9f797068022aab627bd2
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59532025"
---
# <a name="setitemfield"></a>SetItemField

Элемент **SetItemField** представляет собой обновление одного свойства элемента в операции [UpdateItem.](updateitem-operation.md)
...
|[ExtendedFieldURI](extendedfielduri.md) <br/> |Определяет расширенные свойства MAPI для набора.  <br/> |
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[Updates (Item)](updates-item.md) <br/> |Содержит набор элементов, определяющие приложение, набор и удаление изменений свойств элементов.  <br/> |
