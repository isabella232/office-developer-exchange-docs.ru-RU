...
|**Элемент**|**Описание**|
|:-----|:-----|
|[оригиналреЦипиентс](originalrecipients.md) <br/> |Содержит набор адресов электронной почты, которые представляют исходных получателей отслеживаемого сообщения.  <br/> |
|[румлистс](roomlists.md) <br/> |Содержит список комнат для собраний в Организации.  <br/> |
|[сенттоаддрессес](senttoaddresses.md) <br/> |Содержит список адресов электронной почты, на которые должны быть отправлены входящие сообщения, чтобы применялось условие или исключение.  <br/> |
