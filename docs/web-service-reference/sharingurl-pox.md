...
Элемент **SharingUrl** содержит URL-адрес сервера общего доступа, используемого для кросс организации общего доступа к календарям и контактам. 
...
Текстовое значение представляет URL-адрес сервера общего доступа, используемого для кросс организации общего доступа к календарям и контактам.
  
## <a name="remarks"></a>Замечания

Элемент **SharingUrl** является необязательным дочерним элементом элемента **протокола** . 
