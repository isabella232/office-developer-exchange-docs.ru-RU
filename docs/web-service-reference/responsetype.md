...
description: Элемент ResponseType представляет тип ответа получателя, который получается для собрания.
ms.openlocfilehash: d986eff544dc55d257903a2114e87af16eefea97
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59518969"
---
# <a name="responsetype"></a>ResponseType

Элемент **ResponseType** представляет тип ответа получателя, который получается для собрания. 
...
|[MeetingCancellation](meetingcancellation.md) <br/> |Представляет отмену собрания в Exchange магазине  <br/> |
