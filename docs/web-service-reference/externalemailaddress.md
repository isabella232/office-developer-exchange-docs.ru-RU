...
Элемент **ExternalEmailAddress** содержит внешний адрес электронной почты для почтового ящика. 
...
Текстовое значение элемента **ExternalEmailAddress** является внешний адрес электронной почты для почтового ящика. 
