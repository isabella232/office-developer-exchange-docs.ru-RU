...
Элемент **GlobalSize** содержит размер беседы, вычисляемых из размер всех элементов беседы в почтовом ящике. 
...
Текстовое значение элемента **GlobalSize** — размер беседы, вычисляемых из размер всех элементов беседы в почтовом ящике. 
