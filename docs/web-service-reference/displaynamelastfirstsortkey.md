...
Элемент **DisplayNameLastFirstSortKey** содержит ключ сортировки для отображаемого имени в фамилии, имени порядке. 
...
Текстовое значение элемента **DisplayNameLastFirstSortKey** — ключ сортировки для имени пользователя в фамилии, имени порядке. 
