...
description: Элемент FromAddresses указывает адреса электронной почты, с которых входящие сообщения должны отправляться для применения условия или исключения.
ms.openlocfilehash: b58f805b71329ea779c894427eb9fc73ef414902
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59541275"
---
# <a name="fromaddresses"></a>FromAddresses

Элемент **FromAddresses** указывает адреса электронной почты, с которых входящие сообщения должны отправляться для применения условия или исключения. 
