...
---
# <a name="urls-arrayofurlentitiestype"></a>URL-адреса (ArrayOfUrlEntitiesType)

Элемент **URL-адреса** указывает массив URL-адресов, которые являются результатом извлечения объектов из элемента в почтовом ящике. 
