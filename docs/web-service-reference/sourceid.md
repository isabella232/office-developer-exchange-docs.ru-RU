...
Элемент **SourceID** указывает идентификатор контакта с атрибутом в персонаже. 
...
|**Атрибут**|**Описание**|
|:-----|:-----|
|Id  <br/> |Текстовое значение атрибута **ID** — идентификатор контакта.  <br/> |
|чанжекэй  <br/> |Текстовое значение атрибута **чанжекэй** — это ключ изменения контакта.  <br/> |
