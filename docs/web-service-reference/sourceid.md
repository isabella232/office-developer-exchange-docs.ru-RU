...
Элемент **SourceId** указывает идентификатор атрибутами контакт в пользователя. 
...
|**Атрибут**|**Описание**|
|:-----|:-----|
|Id  <br/> |Текстовое значение атрибута **Id** является идентификатор контакта.  <br/> |
|ChangeKey  <br/> |Текстовое значение атрибута **ChangeKey** — это ключ изменения контакта.  <br/> |
