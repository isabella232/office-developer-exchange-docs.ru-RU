...
Элемент **ItemHits** определяет, сколько раз найден ключевое слово. 
...
Текстовое значение элемента **ItemHits** — количество раз, когда найдено ключевое слово для поиска ключевых слов. 
