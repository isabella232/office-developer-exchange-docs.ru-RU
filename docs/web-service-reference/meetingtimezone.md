...
Элемент **MeetingTimeZone** представляет часовой пояс расположение, где размещен собрания. 
...
|**Элемент**|**Описание**|
|:-----|:-----|
|[BaseOffset](baseoffset.md) <br/> |Представляет ежечасно смещение от времени UTC для текущего часового пояса.  <br/> |
