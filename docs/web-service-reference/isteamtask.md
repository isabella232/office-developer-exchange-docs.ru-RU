...
Элемент **IsTeamTask** указывает владеет ли задача группы. 
...
Текстовое значение представляет логическое значение, указывающее, владеет ли задачи группы. Это свойство только для чтения.
