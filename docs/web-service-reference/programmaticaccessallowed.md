...
Элемент **ProgrammaticAccessAllowed** указывает, включена ли программный доступ к для данных управляемых правами. 
...
Текстовое значение **true** для элемента **ProgrammaticAccessAllowed** указывает, что данные программными средствами доступен. Значение **false** указывает, что данные недоступны программными средствами. 
