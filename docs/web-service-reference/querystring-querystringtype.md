...
Текстовое значение элемента **QueryString** представляет запрос к почтовому ящику, который выполняется с помощью подмножества [расширенного синтаксиса запросов (AQS)](http://msdn.microsoft.com/en-us/library/aa965711%28VS.85%29.aspx). В разделе "Примечания" представлены сведения о поддерживаемых параметрах синтаксиса для строк запросов.
...
|to  <br/> |Кому: Деан  <br/> |Поиск элементов, отправленных в Деан.  <br/> |
...
|Основной текст  <br/> Контентная  <br/> |Основной текст: ход выполнения  <br/> Контент: ход выполнения  <br/> |Поиск элементов с ходом выполнения в теле.  <br/> |
