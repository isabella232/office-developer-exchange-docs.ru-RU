...
Элемент **сообщение** содержит сообщение об ошибке Ошибка ответа службы автообнаружения. 
...
Текстовое значение представляет сообщение об ошибке для ошибки ответа службы автообнаружения.
