...
Элемент **Message** содержит сообщение об ошибке для ответа на автообнаружение ошибок. 
...
Текстовое значение представляет сообщение об ошибке для отклика автообнаружения ошибок.
