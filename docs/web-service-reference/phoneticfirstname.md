...
---
# <a name="phoneticfirstname"></a>фонетикфирстнаме

Элемент **фонетикфирстнаме** содержит имя контакта, написанное в фонетическом формате. 
...
Текстовое значение — это строка, представляющая первое имя контакта, написанное в фонетическом формате.
