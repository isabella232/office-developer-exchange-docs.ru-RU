...
Элемент **Email** определяет адрес электронной почты пользователя, для которого запрашивается фотография, в операции **GetUserPhoto** . 
...
Текстовое значение элемента **Email** — это адрес электронной почты пользователя, чье фото запрашивается в операции GetUserPhoto. 
