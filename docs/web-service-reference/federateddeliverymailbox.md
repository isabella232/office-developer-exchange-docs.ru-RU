...
---
# <a name="federateddeliverymailbox"></a>федератедделиверимаилбокс

Элемент **федератедделиверимаилбокс** представляет почтовый ящик, в который было отправлено сообщение с перекрестным локальным сообщением. 
