...
description: Элемент DeletedOccurrences содержит массив удаленных случаев повторяющегося элемента календаря.
ms.openlocfilehash: b1e60bfee9dbc8e5691db2a13474a945da0484af
ms.sourcegitcommit: 54f6cd5a704b36b76d110ee53a6d6c1c3e15f5a9
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 09/24/2021
ms.locfileid: "59510248"
---
# <a name="deletedoccurrences"></a>DeletedOccurrences

Элемент **DeletedOccurrences содержит** массив удаленных случаев повторяющегося элемента календаря. 
...
Этот элемент действителен, если для элемента [CalendarItemType](calendaritemtype.md) используется текстовое значение RecurringMaster. 
