...
Элемент **ContactsFolderPermissionLevel** содержит разрешения для этой папки по умолчанию. Этот элемент появился в Exchange Server 2007 с пакетом обновления 1 (SP1). 
...
|:-----|:-----|
|Нет  <br/> |Делегата не имеет доступа к разрешений для папки «Контакты».  <br/> |
|Редактор  <br/> |Делегат пользователь может читать элементы в папке «Контакты».  <br/> |
|Author  <br/> |Делегата можно читать и создавать элементы в папке «Контакты».  <br/> |
|Редактор  <br/> |Делегата могут читать, создавать и изменять элементы в папке «Контакты».  <br/> |
|Пользовательский сервер  <br/> |Делегата имеет пользовательские разрешения доступа к папке «Контакты».  <br/> |
