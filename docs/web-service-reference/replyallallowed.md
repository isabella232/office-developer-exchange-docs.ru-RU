...
Элемент **ReplyAllAllowed** указывает ли все разрешено для правами ответ управляемых данных. 
...
Текстовое значение **true** для элемента **ReplyAllAllowed** указывает, что все разрешено для права ответ управляемых данных. Значение **false** указывает, что все ответа не допускается. 
