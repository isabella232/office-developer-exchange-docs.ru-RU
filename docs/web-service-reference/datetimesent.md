...
---
# <a name="datetimesent"></a>датетимесент

Элемент **датетимесент** представляет дату и время отправки элемента в почтовом ящике. 
...
Текстовое значение представляет дату и время отправки элемента.
