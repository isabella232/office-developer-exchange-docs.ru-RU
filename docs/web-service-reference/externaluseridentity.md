...
---
# <a name="externaluseridentity"></a>екстерналусеридентити

Элемент **екстерналусеридентити** идентифицирует внешнего пользователя делегата или внешнего пользователя с разрешениями на доступ к папке. 
