...
---
# <a name="scope-highlighttermtype"></a>Область (HighlightTermType)

Элемент **области** указывает строку, которую нужно быть выделены. 
...
Текстовое значение элемента **область** — это область выделенный терминов. 
