...
Элемент **GetAppManifestsResponseMessage** применим для клиентов, которые Exchange Online и версии Microsoft Exchange Server начиная с Exchange 2013 года. 
