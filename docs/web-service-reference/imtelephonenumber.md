...
Элемент **ImTelephoneNumber** представляет номер телефона контакта, который добавляется в мгновенное сообщение группе обмена Мгновенными сообщениями. 
...
Текстовое значение элемента **ImTelephoneNumber** является номер телефона контакта. 
