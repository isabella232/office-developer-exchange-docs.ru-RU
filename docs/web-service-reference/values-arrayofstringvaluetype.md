...
---
# <a name="values-arrayofstringvaluetype"></a>Значения (ArrayOfStringValueType)

Элемент **значения** указывает значения в массиве свойства пользователя, связанные с массивом атрибуты. 
