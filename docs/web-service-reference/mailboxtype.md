...
Элемент **MailboxType** представляет тип почтового ящика, который соответствует адресу электронной почты. 
...
|**Значение**|**Описание**|
|:-----|:-----|
|Почтовый ящик  <br/> |Представляет объект Active Directory, поддержкой электронной почты.  <br/> |
|PublicDL  <br/> |Представляет открытый список рассылки.  <br/> |
|PrivateDL  <br/> |Представляет список рассылки закрытый в почтовом ящике пользователя.  <br/> |
|Контакт  <br/> |Представляет контакт в почтовом ящике пользователя.  <br/> |
|PublicFolder  <br/> |Представляет общей папки.  <br/> |
|Неизвестно  <br/> |Представляет Неизвестный тип почтового ящика.  <br/> |
|OneOff  <br/> |Представляет элемент одноразовых списка рассылки.  <br/> |
|GroupMailbox  <br/> |Представляет почтового ящика группы.  <br/> |
