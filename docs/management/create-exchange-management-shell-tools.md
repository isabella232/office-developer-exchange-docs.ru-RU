...
- [<span data-ttu-id="ae099-125">Windows PowerShell</span><span class="sxs-lookup"><span data-stu-id="ae099-125">Windows PowerShell</span></span>](http://msdn.microsoft.com/en-us/library/dd835506%28v=vs.85%29.aspx)
